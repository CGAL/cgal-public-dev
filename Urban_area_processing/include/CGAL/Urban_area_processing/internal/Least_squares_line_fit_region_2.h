...
#ifndef CGAL_URBAN_AREA_PROCESSING_INTERNAL_LEAST_SQUARES_LINE_FIT_REGION_2_H
#define CGAL_URBAN_AREA_PROCESSING_INTERNAL_LEAST_SQUARES_LINE_FIT_REGION_2_H
...
namespace internal {
  ...
  typename PointMap, 
  typename NormalMap>
  class Least_squares_line_fit_region_2 {
  ...
  public:
    ...
    Least_squares_line_fit_region_2(
...
#endif // CGAL_URBAN_AREA_PROCESSING_INTERNAL_LEAST_SQUARES_LINE_FIT_REGION_2_H
