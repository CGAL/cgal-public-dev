...
#ifndef SURFACE_MESH_MINIMAL_ANGLE_REMESHING_MESH_PROPERTIES_H
#define SURFACE_MESH_MINIMAL_ANGLE_REMESHING_MESH_PROPERTIES_H
...
#endif  // SURFACE_MESH_MINIMAL_ANGLE_REMESHING_MESH_PROPERTIES_H
