...
namespace CGAL {
	...
	namespace Level_of_detail {
		...
		public:
			...
			using LOD_base 		 = LOD::Level_of_detail_reconstruction<Kernel, LOD_input, LOD_normal_map, LOD_label_map>;
		...
		private:
			...
			void set_lod_property_maps() {
				...
				m_lod_label_map  = LOD_label_map();
			}

			void compute_lod_default() {
				
				std::cout << std::endl << "Default LOD pipeline: " << std::endl;
				LOD_base lod_base(m_lod_input, m_lod_normal_map, m_lod_label_map, m_lod_parameters);
