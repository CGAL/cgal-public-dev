...
namespace CGAL {
	...
	namespace Level_of_detail {
        ...
        public:
            ...
            using Labels_matcher         = CGAL::Level_of_detail::Level_of_detail_classification_labels_matcher_2<Kernel, Visibility>;
            using Polygon_sampler        = CGAL::Level_of_detail::Level_of_detail_polygon_sampler_2<Kernel, Polygon>;
            using Polygon_data_estimator = CGAL::Level_of_detail::Level_of_detail_polygon_data_estimator_2<Kernel, Polygon>;
