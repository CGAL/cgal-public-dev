...
namespace CGAL {
	...
	namespace Level_of_detail {
		...
		public:
			...
			typedef CGAL::Level_of_detail::Level_of_detail_building_boundary_and_interior<Kernel, Container> Boundary_and_interior_strategy;
			typedef CGAL::Level_of_detail::Level_of_detail_selector<Kernel, Boundary_and_interior_strategy>  Boundary_and_interior_selector;

			typedef std::pair<int, Point_2> 					 									 Projected_point;
			typedef std::map<int, Point_2>           	   									  		 Projected_points;
			typedef CGAL::Level_of_detail::Level_of_detail_simple_projector<Kernel, Container, Projected_points> Projector;
