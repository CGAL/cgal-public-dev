...
namespace CGAL {
	...
	namespace Level_of_detail {
		...
		public:
			...
			typedef CGAL::Level_of_detail::Level_of_detail_building_interior<Kernel, Container> Roofs_points_selection_strategy;
			typedef CGAL::Level_of_detail::Level_of_detail_building_boundary<Kernel, Container> Walls_points_selection_strategy;
			
			typedef CGAL::Level_of_detail::Level_of_detail_selector<Kernel, Roofs_points_selection_strategy> Roofs_points_selector;
			typedef CGAL::Level_of_detail::Level_of_detail_selector<Kernel, Walls_points_selection_strategy> Walls_points_selector;

			typedef CGAL::Level_of_detail::Level_of_detail_planar_region_growing<Kernel, Mesh, Faces> Planar_region_growing;
