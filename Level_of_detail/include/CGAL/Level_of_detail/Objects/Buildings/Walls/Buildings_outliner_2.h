...
namespace CGAL {
	...
	namespace Level_of_detail {
		...
		public:
			...
			// Extra.
			using Building  = CGAL::Level_of_detail::Building<Kernel, Vertex_handle, Face_handle>;
		...
		private:
			...
			FT compute_label_cost(const Vertex_handle &vh) const {
				...
				switch (vh->info().label) {
					...
					case CGAL::Level_of_detail::Structured_label::CORNER:
						label_cost += corner_cost;
						break;

					case CGAL::Level_of_detail::Structured_label::LINEAR:
						label_cost += linear_cost;
						break;

					case CGAL::Level_of_detail::Structured_label::CLUTTER:
