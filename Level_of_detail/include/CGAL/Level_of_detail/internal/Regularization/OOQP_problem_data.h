#ifndef CGAL_LEVEL_OF_DETAIL_OOQP_PROBLEM_DATA_H
#define CGAL_LEVEL_OF_DETAIL_OOQP_PROBLEM_DATA_H
...
namespace CGAL {
	...
	namespace Level_of_detail {
        ...
        public:
            ...
            size_t number_of_individuals() const {
                
                CGAL_precondition(m_num_individuals > 0);
                return m_num_individuals;
            }

            size_t number_of_variables() const {
                
                CGAL_precondition(m_num_variables > 0);
...
#endif // CGAL_LEVEL_OF_DETAIL_OOQP_PROBLEM_DATA_H