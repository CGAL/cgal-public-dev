	...
	namespace Level_of_detail {
        ...
        private:
            ...
            void set_max_orientations() {
                ...
                if (m_parameters.use_local_orientation())
                  for (size_t i = 0; i < num_input_segments; ++i)
                    m_max_orientations[i] = internal::max_orientation_local(m_parameters, m_input_segments, i);
                
                else for (size_t i = 0; i < num_input_segments; ++i)
                       m_max_orientations[i] = m_parameters.max_angle_in_degrees();
            }
