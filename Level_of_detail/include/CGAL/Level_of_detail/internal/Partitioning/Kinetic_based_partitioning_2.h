	...
	namespace Level_of_detail {
        ...
        public:
            ...
            void compute(const Elements &elements, const Segment_map &segment_map, Output &output) const {
                ...
                for (typename Segments::iterator ce_it = segments.begin();
                     ce_it != segments.end(); ++ce_it)
                {
                  const Segment_2 &segment = get(m_internal_segment_map, *ce_it);
                  ...
                  Segment_2 new_segment = Segment_2(new_source, new_target);
                  put(m_internal_segment_map, *ce_it, new_segment);
                }
        ...
        private:
            ...
            void compute_translation_and_bbox_size(const Segments &segments, Point_2 &translation, Bounding_box_size &bbox_size) const {
                ...
                Bounding_box bbox;
                internal::compute_bounding_box_2(segments, m_internal_segment_map, bbox);
