#ifndef CGAL_LEVEL_OF_DETAIL_OOQP_PROBLEM_H
#define CGAL_LEVEL_OF_DETAIL_OOQP_PROBLEM_H
...
namespace CGAL {
	...
	namespace Level_of_detail {
        ...
        template<class InputKernel, class OOQPProblemData>
		class OOQP_problem {

        public:
            using Kernel            = InputKernel;
            using OOQP_problem_data = OOQPProblemData;
            ...
            OOQP_problem(const Bounds &bounds, const OOQP_problem_data &ooqp_data, const Parameters &parameters, const Regular_segments &segments) : 
            m_bounds(bounds), 
            m_ooqp_data(ooqp_data), 
            ...
            void solve(Solution_ft_type &solution_ft_type) {
                ...
                const Mus_matrix &mus_matrix = m_ooqp_data.get_mus_matrix();
        ...
        private:
            ...
            const OOQP_problem_data &m_ooqp_data;
            ...
            double get_maximum_bound() const {
                CGAL_precondition(m_bounds.size() > 0);

                FT max_bound = -m_big_value;
            ...
            void allocate_inequality_constraints(int **p_rowC, int **p_colC, double **p_dC, double **p_clow, char **p_iclow, double **p_cupp, char **p_icupp) {
                ...
                const Mus_matrix         &mus_matrix = m_ooqp_data.get_mus_matrix();
                const Targets_matrix &targets_matrix = m_ooqp_data.get_targets_matrix();
...
#endif // CGAL_LEVEL_OF_DETAIL_OOQP_PROBLEM_H