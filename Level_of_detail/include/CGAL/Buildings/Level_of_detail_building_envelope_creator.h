...
namespace CGAL {
	...
	namespace LOD {
        ...
        public:
            ...
            void find_envelope(Buildings &buildings) const {
        ...
        private:
            ...
            void update_roofs(const Envelope_diagram &diagram, const Data_triangles &triangles, Building &building) const {
                ...
                for (Face_iterator fit = diagram.faces_begin(); fit != diagram.faces_end(); ++fit) {
                    ...
                    do {
                        ...
                        find_associated_planes(fit, plane_indices);

                        boundary.push_back(Point_3(x, y, z));
                        associated_planes.push_back(plane_indices);
            ...
            void find_associated_planes(const Face_iterator &fit, Plane_indices &plane_indices) const {
