...
#warning ACK uses bisolve for CA
#endif
...
#warning ACK bisolve-CA uses Teissier test
#else
...
#endif
#if CGAL_ACK_CURVE_ANALYSES_MULT_RES_FX_FY_PREFER_SIGN_AT
#warning ACK bisolve-CA prefers sign_at_1 for mult_res_fx_fy
#endif
#endif
...
#warning ACK uses bisolve for CPA
#endif
