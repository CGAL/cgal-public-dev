...
//
// $URL: svn+ssh://algerbya@scm.gforge.inria.fr/svn/cgal/branches/features/Algebraic_kernel_d-RS_bivariate-nancy/Algebraic_kernel_d/include/CGAL/RS/algebraic_1_real_embeddable.h $
// $Id: algebraic_1_real_embeddable.h 59002 2010-10-04 11:00:27Z lrineau $
//
...
namespace CGAL {
  ...
  template<>
    class Real_embeddable_traits< New_Algebraic_1  >
    : public INTERN_RET::Real_embeddable_traits_base<  New_Algebraic_1  , CGAL::Tag_true > {

public:
    typedef INTERN_RET::Real_embeddable_traits_base<  New_Algebraic_1  , CGAL::Tag_true > Base;
