...
// default RS_AK_1
#include <CGAL/simple_ak_rs_1.h>

// different isolators
#include <CGAL/RS/simple_rs2_isolator_1.h>
#include <CGAL/RS/simple_k_isolator_1.h>
...
int main(){
        ...
        typedef CGAL::Simple_algebraic_kernel_rs_gmpz_d_1       AK_default;

        typedef CGAL::Polynomial<CGAL::Gmpz>                    Polynomial;
        typedef CGAL::Gmpfr                                     Bound;

        // the RS2-only kernel
        typedef CGAL::RS2::Simple_rs2_isolator_1<Polynomial,Bound>
                                                                RS2_isolator;
        typedef CGAL::Simple_bisection_refiner_1<Polynomial,Bound>
                                                                B_refiner;
        ...
        // the RS2/RS3 kernel
        typedef CGAL::Simple_k_isolator_1<Polynomial,Bound>     K_isolator;
        typedef CGAL::RS3::Simple_rs3_refiner_1<Polynomial,Bound>
                                                                RS3_refiner;
        typedef CGAL::SimpleAK1::Simple_algebraic_kernel_1<
                                        Polynomial,
                                        Bound,
                                        K_isolator,
                                        RS3_refiner>            AK_RS2_RS3;

        // test all and return the result
        int result;
        std::cerr<<"testing default RS_AK_1:";
        result+=test_ak<AK_default>();
        std::cerr<<"testing RS2 AK_1:";
        result+=(2047+test_ak<AK_RS2>());
        std::cerr<<"testing RS2/RS3 AK_1:";
