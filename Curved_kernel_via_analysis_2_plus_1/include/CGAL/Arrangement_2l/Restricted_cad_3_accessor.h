...
public:
    ...
    typedef typename RSC_3::Coordinate_1 Coordinate_1;
    
    //! type of Bound
    typedef typename RSC_3::Bound Bound;
    ...
    void remove_edge(Halfedge_handle he, bool remove_source,
             bool remove_target) {
        _m_rscad._remove_edge(he, remove_source, remove_target);
    }
     ...
     */
    static
    Point_2 construct_point_with_rational_y(Coordinate_1 x0, Bound y0) {
