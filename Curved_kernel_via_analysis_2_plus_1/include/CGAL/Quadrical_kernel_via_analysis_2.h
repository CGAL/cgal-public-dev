...
//
// $URL: svn+ssh://eric@scm.gforge.inria.fr/svn/cgal/branches/experimental-packages/Curved_kernel_via_analysis_2_plus_1/include/CGAL/Quadrical_kernel_via_analysis_2.h $
// $Id: Quadrical_kernel_via_analysis_2.h 56671 2010-06-09 12:31:27Z sloriot $
//
//
...
public:
    ...
    result_type operator()(const Point_2& p1, const Point_2& p2,
        ...
        CGAL::Comparison_result res =
            (equal_x ? CGAL::EQUAL :
             Curved_kernel_via_analysis_2l::instance().kernel().
             compare_1_object()(p1.x(), p2.x())
            );
