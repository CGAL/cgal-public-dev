...
\ccRefIdfierPage{CGAL::Random_points_in_triangle_2<Point_2>}\\
\ccRefIdfierPage{CGAL::Random_points_in_triangle_3<Point_3>}\\
\ccRefIdfierPage{CGAL::Random_points_in_tetrahedron_3<Point_3>}\\
\ccRefIdfierPage{CGAL::Random_points_in_mesh_3<Point_3, C3t3>}\\
\ccRefIdfierPage{CGAL::Random_points_in_surface_mesh_3<Point_3, C2t3>}\\
