...
If \ccc{CGAL_USE_EIGEN3} is defined, \ccc{LocalKernel} and \ccc{SvdTraits}
template parameters have defaults, \ccc{Cartesian<double>} and \ccc{Eigen_svd} respectively.
