...
/*!
issued just before all inner ccbs in the face `from_f` are moved to
the face `to_f`. This can happen when the face `from_f` containing the
inner ccbs is about to merge with the face `to_f` due to the removal of
...
/*!
issued just before all isolated vertices in the face `from_f` are moved
to the face `to_f`. This can happen when the face `from_f` containing the
isolated vertices is about to merge with the face `to_f` due to the removal
