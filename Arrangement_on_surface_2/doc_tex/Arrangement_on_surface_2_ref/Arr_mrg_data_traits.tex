...
if and only if \ccc{Tr}~models the concept.
In this case~\ccc{Has_construct_x_monotone_curve_2_category} is
identical to the one in~\ccc{Tr}.
...
\ccIsModel
    ...
    \ccc{ArrangementLandmarkTraits_2} (if and only if \ccc{Tr} models the
