...
\ccc{NtTraits::Algebraic} number types, respectively. It is recommended to
...
The traits-class also models the \ccc{ArrangementLandmarkTraits_2} concept
...
subdivide a \ccc{Curve_2} object into $x$-monotone subcurves.
