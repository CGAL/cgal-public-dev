...
it can be a rather costly operation. A constructor for points using a rational
...
internally it constructs a supporting rational function and its $x$-coordinate.
