...
An additional operation is optional and is intended to expedite the
walk:
\begin{description}
\item[\ccc{Construct_x_monotone_curve_2}:] Optional: Given two points $p_1$ and
...
\ccc{ArrangementLandmarkTraits_2} it does not supply the
\ccc{Construct_x_monotone_curve_2} functor. The traits class template 
...
Boolean set operations. Note that though the class models the
\ccc{ArrangementLandmarkTraits_2} it does not supply the
\ccc{Construct_x_monotone_curve_2} functor.
...
\ccc{ArrangementTraits_2} and \ccc{ArrangementLandmarkTraits_2}.
