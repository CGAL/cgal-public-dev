...
\ccc{Arr_walk_along_a_line_point_location<Arrangement>} strategy.
The walk could be expedited by constructing a curve connecting the
landmark point and the query point (which not all traits classes
support).
