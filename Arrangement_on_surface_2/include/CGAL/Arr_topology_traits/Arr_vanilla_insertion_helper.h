...
#ifndef CGAL_ARR_VANILLA_INSERTION_HELPER_H
#define CGAL_ARR_VANILLA_INSERTION_HELPER_H

/*! \file
 * Definition of the Arr_vanilla_insertion_helper class-template.
 */
...
public:
  ...
  typedef Arr_vanilla_insertion_helper<Traits_2, Arrangement_2, Event,
                                         Subcurve>      Self;
...
public:
  /*! Constructor */
  Arr_vanilla_insertion_helper(Arrangement_2 *arr) : Base(arr) {}

  /*! Destructor. */
  virtual ~Arr_vanilla_insertion_helper() {}
