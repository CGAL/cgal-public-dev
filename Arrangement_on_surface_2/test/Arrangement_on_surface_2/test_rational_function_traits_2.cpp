...
int main(int argc, char* argv[])
{
    ...
    construct_x_monotone_curve_2 = traits.construct_x_monotone_curve_2_object();
  {
    ...
    typedef Construct_x_monotone_curve_2::X_monotone_curve_2 X_monotone_curve_2; 
    typedef Construct_x_monotone_curve_2::argument_type argument_type;
    typedef Construct_x_monotone_curve_2::first_argument_type first_argument_type; 
    typedef Construct_x_monotone_curve_2::second_argument_type second_argument_type; 
  }
