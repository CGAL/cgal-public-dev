...
class Bench_apollonius 
  : public Basic_voronoi<Apollonius_traits::Site_2>
{
public:
  void op();
};
...
: public Basic_voronoi<EXACUS_apollonius_traits::Surface_3>
{
  typedef Basic_voronoi<EXACUS_apollonius_traits::Surface_3> Base;
  typedef Base::Sites                                        Base_sites;
  
  typedef AT::Rational                                       Rational;

  typedef std::vector< P_quadric_3 >   Quadrics;
...
class Bench_sphere
  : public Basic_voronoi<Sphere_traits::Site_2>
{
public:
  void op();
};
