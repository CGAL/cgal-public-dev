...
/*! \class Algebraic_farthest_point_farthest_site_traits_2 We define a distance
 * function from a disk to as the longest distance from the given point to a
 * point on on the disk. We define the Vornoi diagram with respect to that
 * distance funtion - "furthest" distance function.
...
class Algebraic_farthest_point_farthest_site_traits_2 :
    public Algebraic_apollonius_traits_base_2
      <CurvedKernel_,
       Algebraic_farthest_point_farthest_site_traits_2<CurvedKernel_>,
       ...
       CGAL::Field_with_sqrt_tag>
{
  ...
  using Self = Algebraic_farthest_point_farthest_site_traits_2<Curved_kernel_2>;
  using Site_2 =
    Envelope_voronoi_traits_2::_Apollonius_disk
    <typename CurvedKernel_::Curve_kernel_2::Coordinate_1::Rational>;
  ...
  */
  ...
  public:
    ...
    template <typename OutputIterator>
      ...
      return m_traits->apollonius_bisector(s1.center().first, s1.center().second,
                                           s2.r(),
                                           s2.center().first, s2.center().second,
                                           s1.r(), *m_traits, o);
    }
  };
