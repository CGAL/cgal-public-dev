...
template <class Rat_kernel_, class Alg_kernel_, class Nt_traits_>
  ...
  public CGAL::Arr_tracing_traits_2< 
    Arr_conic_traits_2<Rat_kernel_, Alg_kernel_, Nt_traits_> >
#else
    template <class Rat_kernel_, class Alg_kernel_, class Nt_traits_>
    class Apollonius_diagram_traits_2 : public Arr_conic_traits_2<Rat_kernel_, Alg_kernel_, Nt_traits_>
#endif
{
public:
  ...
  typedef Arr_conic_traits_2<Rat_kernel, Alg_kernel, Nt_traits> 
    Base;
  typedef Apollonius_diagram_traits_2<Rat_kernel, Alg_kernel, Nt_traits>
    Self;
  ...
  typedef _Apollonius_site               Site_2;
  ...
  public:
...

    {
      ...
      if (s == ZERO)
      {
        Comparison_result res = ker.compare_y_2_object() (h2.center(), h1.center());
        if (res == EQUAL)
      ...
      CGAL_envelope_voronoi_assertion_msg (res != EQUAL, "The center can be on the bisector.");
  ...
  public:
                                ...
                                OutputIterator o) const
    {
      ...
      if (nt_traits.convert(xx_2 + yy_2) <= RS)
        return o;
      ...
      // So we intersect the hyperbola / line with a line parallel to the major axis of the 
      // hyperbola / perpendicular to the line
      ...
      // We use to approximated points. one is above the center of the circle, and one
      // is below.
      Rat_line_2 axis = ker.construct_line_2_object () (p_small, p_big);
      Rat_line_2 perpend = ker.construct_perpendicular_line_2_object () 
        (axis, p_small);
      ...
      Rat_point_2 app_point1 = ker.construct_translated_point_2_object () 
        (p_small, vec);
      Rat_point_2 app_point2 = ker.construct_translated_point_2_object () 
        (p_small, opp_vec);

      // and these are their lines (which will intersect the hyperbola).
      Rat_line_2 inter_line1 = ker.construct_perpendicular_line_2_object ()
        (perpend, app_point1);
      Rat_line_2 inter_line2 = ker.construct_perpendicular_line_2_object ()
        (perpend, app_point2);
