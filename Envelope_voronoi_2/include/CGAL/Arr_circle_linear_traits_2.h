...
public:
  ...
  typedef _Circle_linear_2<Kernel, Filter_>              Curve_2;
  typedef _X_monotone_circle_linear_2<Kernel, Filter_>  X_monotone_curve_2;
  typedef unsigned int                                   Multiplicity;
  typedef Arr_circle_linear_traits_2<Kernel, Filter_>   Self;
...
public:
  ...
  public:
                                   ...
                                   Arr_curve_end ce) const
    {
      ...
      {
        return xcv.has_right() ? ARR_INTERIOR : ARR_RIGHT_BOUNDARY;
      }
    }
  ...
  public:
                                   ...
                                   Arr_curve_end ce) const
    {
      ...
      {
        return xcv.has_right() ? ARR_INTERIOR : ARR_TOP_BOUNDARY;
      }
    }
...
// ophir - continue here.
  ...
  public:
                                 ...
                                 Arr_curve_end ce) const
    {
      ...
      CGAL_precondition ((ce == ARR_MIN_END &&
                          ...
                          xcv2.has_left() == false) ||
                         (ce == ARR_MAX_END &&
                          xcv1.has_right() == false &&
                          xcv2.has_right() == false));
  ...
  {
  private:
    typedef Arr_circle_linear_traits_2<Kernel_, Filter_> Self;
  ...
  public:
    ...
    {
      typedef typename Curve_2::Base           Base;
