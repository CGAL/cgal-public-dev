...
inline void print_error (const char* mess)
{
  std::cerr << mess << std::endl;
}

//namespace CL { namespace MRF {
...
public:
	...
	Energy(void (*err_function)(const char *) = &print_error);
...
template <typename V, typename T>
inline int Energy<V,T>::get_var(Var x) { return (int) this->what_segment(x); }
//}}
#endif
