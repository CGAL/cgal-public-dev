...
void test1() {
    ...
    assert(ep.classify(p1)==CGAL::EXTREME_POINT);
    assert(ep.classify(p2)==CGAL::EXTREME_POINT);
    assert(ep.classify(p3)==CGAL::EXTREME_POINT);
    assert(ep.classify(p4)==CGAL::EXTREME_POINT);
    assert(ep.classify(p5)==CGAL::EXTREME_POINT);
    assert(ep.classify(p6)==CGAL::EXTREME_POINT);
    assert(ep.classify(p7)==CGAL::EXTREME_POINT);
    assert(ep.classify(p8)==CGAL::EXTREME_POINT);
    assert(ep.classify(p9)==CGAL::EXTREME_POINT);
    assert(ep.classify(p15)==CGAL::EXTREME_POINT);
    assert(ep.classify(p10)==CGAL::INTERNAL_POINT);
    assert(ep.classify(p11)==CGAL::INTERNAL_POINT);
    assert(ep.classify(p12)==CGAL::INTERNAL_POINT);
    assert(ep.classify(p13)==CGAL::INTERNAL_POINT);
    assert(ep.classify(p14)==CGAL::INTERNAL_POINT);

    assert(ep.classify(Point_3(.1,.1,.1))==CGAL::INTERNAL_POINT);
    assert(ep.classify(Point_3(1.,0.,.5))==CGAL::INTERNAL_POINT);
    assert(ep.classify(Point_3(1.,.3,0.))==CGAL::INTERNAL_POINT);
    assert(ep.classify(Point_3(.1,.1,.1))==CGAL::INTERNAL_POINT);
    
    assert(ep.classify(Point_3(.5,.5,2.1))==CGAL::EXTERNAL_POINT);
    assert(ep.classify(Point_3(.5,.5,-.1))==CGAL::EXTERNAL_POINT);
    assert(ep.classify(Point_3(-.5,0.,0.))==CGAL::EXTERNAL_POINT);
