...
void test1() {
    ...
    assert(ep.classify(Point_d(d,coord1,coord1+d))==CGAL::EXTREME_POINT);
    assert(ep.classify(Point_d(d,coord2,coord2+d))==CGAL::EXTREME_POINT);
    assert(ep.classify(Point_d(d,coord3,coord3+d))==CGAL::EXTREME_POINT);
    assert(ep.classify(Point_d(d,coord4,coord4+d))==CGAL::EXTREME_POINT);
    assert(ep.classify(Point_d(d,coord5,coord5+d))==CGAL::EXTREME_POINT);
    assert(ep.classify(Point_d(d,coord6,coord6+d))==CGAL::EXTREME_POINT);
    assert(ep.classify(Point_d(d,coord7,coord7+d))==CGAL::EXTREME_POINT);
    assert(ep.classify(Point_d(d,coord8,coord8+d))==CGAL::EXTREME_POINT);
    assert(ep.classify(Point_d(d,coord9,coord9+d))==CGAL::EXTREME_POINT);
    assert(ep.classify(Point_d(d,coord10,coord10+d))==CGAL::EXTREME_POINT);
    assert(ep.classify(Point_d(d,coord11,coord11+d))==CGAL::EXTREME_POINT);
    assert(ep.classify(Point_d(d,coord12,coord12+d))==CGAL::EXTREME_POINT);
    assert(ep.classify(Point_d(d,coord13,coord13+d))==CGAL::EXTREME_POINT);
    assert(ep.classify(Point_d(d,coord14,coord14+d))==CGAL::EXTREME_POINT);
    assert(ep.classify(Point_d(d,coord15,coord15+d))==CGAL::EXTREME_POINT);
    assert(ep.classify(Point_d(d,coord16,coord16+d))==CGAL::EXTREME_POINT);


    assert(ep.classify(Point_d(d,coord,coord+d))==CGAL::INTERNAL_POINT);
    for (int i=0; i<d; ++i)
      coord[i]=10.;
    assert(ep.classify(Point_d(d,coord,coord+d))==CGAL::EXTERNAL_POINT);
