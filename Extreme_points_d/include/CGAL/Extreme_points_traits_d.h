...
/*! 
   ...
   and for the functions `CGAL::extreme_points_d`, `CGAL::extreme_points_d_dula_helgason` and `CGAL::extreme_points_d_simple`.
   ...
   For other points, user must provide the traits class.
