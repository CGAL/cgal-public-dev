...
/// which the class `CGAL::KDOP_tree<KDOPTraits>` may receive an intersection
...
/// type `Query` for which the class `CGAL::KDOP_tree<KDOPTraits>` may receive a
/// distance query.
/// @{
...
/// In addition, if `Primitive` is a model of the concept `KDOPPrimitiveWithSharedData`,
