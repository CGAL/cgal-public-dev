...
int main(int argc, char* argv[])
{
  ...
  kdop_directions.push_back( Point(0.5, -0.707107, 0.5) );
  kdop_directions.push_back( Point(0.543055, 0.705772, 0.454947) );
  kdop_directions.push_back( Point(0.699204, -0.0110554, -0.714837) );
