...
namespace ASP = CGAL::Surface_mesh_approximate_shortest_path_3;
...
typedef ASP::Never_skip_condition        Skip_condition;
//typedef ASP::Always_enqueue_in_A<Kernel>         Enqueue_policy;
//typedef ASP::Static_speed_limiter<Kernel>         Enqueue_policy;
typedef ASP::Embedding_space_distance_limiter<Kernel>         Enqueue_policy;
...
int main(int argc, char** argv)
{
  ...
  std::cout << "number of mesh faces: " << num_faces(tmesh) << std::endl;
