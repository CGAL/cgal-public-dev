...
// TODO: code reuse between the following two functions
...
operator>>(std::istream& is, Triangulation_data_structure_3<Vb,Cb>& tds)
  ...
  // the neighbors of each cell by their index in the preceding vector of cells
...
get_vertices_from_vertex_link(Vertex_handle vertex, Vertex_handle_set& vertices) const
{
  ...
  switch ( dimension() ) {
    case 3: {
      ...
      typename std::vector<Cell_handle>::const_iterator it;
...
void
Triangulation_data_structure_3<Vb,Cb>::
get_facets_from_link(Vertex_handle vertex, Vertex_handle dont_include, std::vector<Facet>& hull) const
{
  CGAL_triangulation_precondition( dimension() == 3 );
...
void
Triangulation_data_structure_3<Vb,Cb>::
get_edges_from_link(Vertex_handle vertex, Vertex_handle dont_include, std::vector<Edge>& hull) const
{
  CGAL_triangulation_precondition( dimension() == 2 );
...
collapse_collapsible(Edge& edge)
{
  ...
  switch ( dimension() ) {
    ...
    case 2: {
      ...
      std::vector<Cell_handle> source_star_cells;
