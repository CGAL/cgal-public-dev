...
#ifndef CGAL_POISSON_RECONSTRUCTION_SMOOTH_FUNCTION_H
#define CGAL_POISSON_RECONSTRUCTION_SMOOTH_FUNCTION_H
...
/*!
  \file Poisson_reconstruction_smooth_function.h
*/
...
`Poisson_reconstruction_smooth_function` implements a variant of this
...
*/
template <class Gt>
class Poisson_reconstruction_smooth_function
{
// Public types
public:
...
public:
  ...
  */
  template <typename InputIterator,
            ...
            typename NormalPMap
  >
  Poisson_reconstruction_smooth_function(
                                 ...
                                 double average_spacing_ratio = 5)
  {
    ...
    if(approximation_ratio > 0. &&
      ...
      Poisson_reconstruction_smooth_function<Geom_traits>
      ...
      Special_wrapper_of_two_functions_keep_pointers<
        internal::Poisson::Constant_sizing_field<Triangulation>,
        Poisson_reconstruction_smooth_function<Geom_traits> > sizing_field2(&min_sizing_field,
  ...
  */
  ...
  boost::tuple<FT, Cell_handle, bool> special_func(const Point& p) const
  {
    ...
    double f[4];
		...
		for (int i = 0; i < 4; i++)
		{
			Vertex_handle v = m_hint->vertex(i);
...
}; // end of Poisson_reconstruction_smooth_function
...
#endif // CGAL_POISSON_RECONSTRUCTION_SMOOTH_FUNCTION_H
