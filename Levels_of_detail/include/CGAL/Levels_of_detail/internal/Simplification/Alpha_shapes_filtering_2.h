...
namespace internal {
  ...
  public:
    ...
    void get_filtered_points(
      ...
      if (m_triangulation.number_of_faces() == 0)
        return;
      ...
      for (
        ...
        sample_edge(source, target, sampling_2, result);
      }
    }
  ...
  private:
    ...
    void sample_edge(
      ...
      CGAL_precondition(sampling_2 > FT(0));
      const std::size_t nb_pts = 
      static_cast<std::size_t>(CGAL::to_double(distance / sampling_2)) + 1;
