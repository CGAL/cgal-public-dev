	...
	namespace Level_of_detail {
        ...
        private:            
            ...
            void set_max_differences() {
                ...
                if (m_parameters.use_local_difference())
                  for (size_t i = 0; i < num_input_segments; ++i)
                    m_max_differences[i] = internal::max_difference_local (m_parameters, m_input_segments, i);
                
                else for (size_t i = 0; i < num_input_segments; ++i)
                       m_max_differences[i] = m_parameters.max_difference_in_meters();
            }
