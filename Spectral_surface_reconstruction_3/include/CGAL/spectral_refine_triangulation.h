...
#ifndef CGAL_SPECTRAL_REFINE_TRIANGULATION_H
#define CGAL_SPECTRAL_REFINE_TRIANGULATION_H
...
#include <CGAL/Mesh_3/Spectral_refine_cells_3.h>
#include <CGAL/Spectral_mesh_cell_criteria_3.h>
...
/// Utility class for spectral_refine_triangulation():
...
>
class Spectral_mesher_level_impl_base :
    public Mesh_3::Spectral_refine_tets_with_oracle_base<Tr, Criteria, Surface, Oracle, Container>
{
  typedef Mesh_3::Spectral_refine_tets_with_oracle_base<Tr, Criteria, Surface, Oracle, Container> Base;
...
public:
  ...
  Spectral_mesher_level_impl_base(Tr& t, Criteria crit, unsigned int max_vert, Surface& surface, Oracle& oracle)
...
}; // end Spectral_mesher_level_impl_base


/// Utility class for spectral_refine_triangulation():
/// glue class that inherits from both Mesher_level
/// and Spectral_mesher_level_impl_base.
template <typename Tr,
 ...
 >
class Spectral_mesher_level :
  public Spectral_mesher_level_impl_base<Tr, Criteria, Surface, Oracle>,
  public Mesher_level <
    Tr,
    Spectral_mesher_level<Tr, Criteria, Surface, Oracle, PreviousLevel>,
    typename Tr::Cell_handle,
    PreviousLevel,
    Triangulation_mesher_level_traits_3<Tr>
  >
{
  typedef Spectral_mesher_level_impl_base<Tr, Criteria, Surface, Oracle> Base;
...
public:
  ...
  Spectral_mesher_level(Tr& t, Criteria criteria, unsigned int max_vertices, Surface& surface, Oracle& oracle, PreviousLevel& previous_level)
    : Base(t, criteria, max_vertices, surface, oracle),
      Mesher(previous_level)
  {
  }

}; // end class Spectral_mesher_level
...
unsigned int spectral_refine_triangulation(
  Tr& tr,
  ...
  Surface& enlarged_bbox) ///< new bounding sphere or box
{
  ...
  // Mesher_level types
  typedef Spectral_mesh_cell_criteria_3<
    Tr
    , Sizing_field
    , Second_sizing_field
    > Tets_criteria;
  typedef typename CGAL::Surface_mesh_traits_generator_3<Surface>::type Oracle;
  typedef Spectral_mesher_level<Tr, Tets_criteria, Surface, Oracle, Null_mesher_level> Refiner;
...
#endif // CGAL_SPECTRAL_REFINE_TRIANGULATION_H
