...
#ifndef CGAL_SPECTRAL_MESH_CRITERIA_3_H
#define CGAL_SPECTRAL_MESH_CRITERIA_3_H
...
} // end namespace Spectral
} // end namespace internal

template <
  class Tr, 
  typename Sizing_field = internal::Spectral::Constant_sizing_field<Tr>,
  typename Second_sizing_field = internal::Spectral::Constant_sizing_field<Tr> 
  >
class Spectral_mesh_cell_criteria_3 
{
  Sizing_field sizing_field;
  Second_sizing_field second_sizing_field;
  double radius_edge_bound_;

  typedef Spectral_mesh_cell_criteria_3<Tr, 
                                       Sizing_field,
...
public:
  ...
  Spectral_mesh_cell_criteria_3(const double radius_edge_bound = 2, //< radius edge ratio bound (ignored if zero)
  ...
  Spectral_mesh_cell_criteria_3(const double radius_edge_bound, //< radius edge ratio bound (ignored if zero)
...
}; // end Spectral_mesh_cell_criteria_3

  template <typename Tr>
  std::ostream& operator<<(std::ostream& os,
                           const typename Spectral_mesh_cell_criteria_3<Tr>::Cell_quality& q)
  {
...
#endif // CGAL_SPECTRAL_MESH_CRITERIA_3_H
