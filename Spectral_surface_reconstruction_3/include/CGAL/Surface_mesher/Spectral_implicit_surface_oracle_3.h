...
#ifndef CGAL_SURFACE_MESHER_SPECTRAL_IMPLICIT_SURFACE_ORACLE_3_H
#define CGAL_SURFACE_MESHER_SPECTRAL_IMPLICIT_SURFACE_ORACLE_3_H
...
(Computed by use of:
 ...
 perl -ne '/GT::([a-zA-Z_0-9]+)/
  ...
  template <
    ...
    >
  class Spectral_implicit_surface_oracle_3
  {
    // private types
    typedef Spectral_implicit_surface_oracle_3<GT,
                                      Surface,
                                      Transform_functor_,
  ...
  public:
    ...
    // Constructors
//     Spectral_implicit_surface_oracle_3 (Visitor visitor_ = Visitor()) :
//       visitor(visitor_), 
//       transform_functor(),
//       surface_identifiers_generator()
//     {
// #ifdef CGAL_SURFACE_MESHER_DEBUG_CONSTRUCTORS
//       std::cerr << "CONS: Spectral_implicit_surface_oracle_3\n";
// #endif
//     }

    Spectral_implicit_surface_oracle_3 (Transform_functor transform_functor
                                 = Transform_functor(),
                               Surface_identifiers_generator
                                 surface_identifiers_generator
                                   = Surface_identifiers_generator(),
...
#ifdef CGAL_SURFACE_MESHER_DEBUG_IMPLICIT_ORACLE
        std::cerr << 
          boost::format("** Spectral_implicit_surface_oracle_3::operator()( (%1%), (%2%) )\n")
          % a % b;
#endif
  ...
  };  // end Spectral_implicit_surface_oracle_3
...
#endif  // CGAL_SURFACE_MESHER_SPECTRAL_IMPLICIT_SURFACE_ORACLE_3_H
