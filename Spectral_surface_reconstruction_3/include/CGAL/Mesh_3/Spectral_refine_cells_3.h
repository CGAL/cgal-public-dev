...
#ifndef CGAL_MESH_3_SPECTRAL_REFINE_CELLS_3_H
#define CGAL_MESH_3_SPECTRAL_REFINE_CELLS_3_H
...
template <class Tr,
          ...
          >
class Spectral_refine_tets_base :
    public Container,
...
public:
  ...
  Spectral_refine_tets_base(Tr& t, Criteria crit) 
...
#  endif
  ...
  {
    std::cerr << "Spectral_refine_tets: before conflicts of " << p;
  }
#else
...
template <class Tr,
          ...
          class Container = Meshes::Double_map_container<
            ...
            typename Criteria::Cell_quality>
>
class Spectral_refine_tets_with_oracle_base 
  : public Spectral_refine_tets_base<Tr,
                            Criteria,
                            Container>
{
public:
  typedef Spectral_refine_tets_base<Tr, Criteria, Container> Base;
  typedef Spectral_refine_tets_with_oracle_base<Tr, 
                                       Criteria,
                                       Surface,
                                       Oracle,
                                       Container> Self;
  ...
  Spectral_refine_tets_with_oracle_base(Tr& t, Criteria crit, Surface& s, Oracle& o)
 ...
 Zone conflicts_zone_impl(const Point& p, Cell_handle c) const
  {
    ...
    if (triangulation_ref_impl().side_of_sphere(c, p, true) != ON_BOUNDED_SIDE)
      std::cerr << "Spectral_refine_tets_with_oracle_base::conflicts_zone_impl: ERROR: circumcenter out of sphere!\n";
#endif
...
}; // end Spectral_refine_tets_with_oracle_base
...
template <typename Tr,
          ...
          typename BaseP = // workaround for VC7, see below
             Spectral_refine_tets_with_oracle_base<Tr, Criteria, Surface, Oracle>,
          typename Facets_level = Refine_facets<Tr>
 >
class Spectral_refine_tets : 
  public BaseP, 
  public Mesher_level <
    Tr,
    Spectral_refine_tets<Tr, Criteria, Surface, Oracle, BaseP, Facets_level>,
    typename Tr::Cell_handle,
    Facets_level,
...
public:
  typedef Spectral_refine_tets<Tr, Criteria, Surface, Oracle, Base, Facets_level> Self;
  typedef Mesher_level <
    Tr,
    Spectral_refine_tets<Tr, Criteria, Surface, Oracle, Base, Facets_level>,
    typename Tr::Cell_handle,
    Facets_level,
    Triangulation_mesher_level_traits_3<Tr>
  > Mesher;
  
  Spectral_refine_tets(Tr& t, Criteria crit, Surface& surface, Oracle& oracle, Facets_level& facets_level)
...
}; // end class Spectral_refine_tets

} // end namespace Mesh_3
} // end namespace CGAL

#endif // CGAL_MESH_3_SPECTRAL_REFINE_CELLS_3_H
