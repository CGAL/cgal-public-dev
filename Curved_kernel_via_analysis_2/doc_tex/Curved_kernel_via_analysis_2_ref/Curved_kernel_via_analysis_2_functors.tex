...
\begin{ccRefClass}[CGAL::internal::]{Curved_kernel_via_analysis_2_functors}  %% add template arg's if necessary
\ccRefLabel{Curved_kernel_via_analysis_2_functors}
...
%% \ccIncludeExampleCode{Curved_kernel_via_analysis_2/Curved_kernel_via_analysis_2_functors.C}
