% +------------------------------------------------------------------------+
% | Reference manual page: Equal_2.tex
% +------------------------------------------------------------------------+
% | 27.03.2008   Author
% | Package: Curved_kernel_via_analysis_2
% |
\RCSdef{\RCSEqualRev}{$Id: header.tex 40270 2007-09-07 15:29:10Z lsaboret $}
\RCSdefDate{\RCSEqualDate}{$Date: 2007-09-07 17:29:10 +0200 (Fri, 07 Sep 2007) $}
% |
\ccRefPageBegin
...
\begin{ccRefFunctionObjectClass}[CGAL::internal::Curved_kernel_via_analysis_2_Functors::]{Equal_2}  %% add template arg's if necessary
\ccRefLabel{Equal_2}
...
%% \ccIncludeExampleCode{Curved_kernel_via_analysis_2/Equal_2.C}
...
\ccConstructor{Equal_2(Curved_kernel_via_analysis_2 * kernel);}
{
...
\end{description}
\begin{description}
\item[Returns:]true if the two point are the same; false otherwise. \end{description}
\ccGlue
\ccMethod{result_type operator()(const Arc_2& cv1, const Arc_2& cv2) const;}
{
...
\end{description}
\begin{description}
\item[Returns:]true if the two curves are the same; false otherwise. \end{description}
\ccGlue
