...
\begin{ccRefFunctionObjectClass}[CGAL::internal::Curved_kernel_via_analysis_2_Functors::]{Construct_point_on_arc_2}  %% add template arg's if necessary
...
\ccMethod{Point_2 operator()(const Coordinate_1& x, const Curve_analysis_2& c, int arcno, const Arc_2& arc);}
{
