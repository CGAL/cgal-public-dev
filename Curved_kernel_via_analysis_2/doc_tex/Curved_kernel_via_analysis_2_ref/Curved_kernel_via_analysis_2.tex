...
\ccInclude{CGAL/Curved_kernel_via_analysis_2.h}
...
\ccc{Curved_kernel_via_analysis_2_base<boost::mpl::if_< boost::mpl::bool_< boost::is_void< CKvA_>::value} $>$, \ccc{Curved_kernel_via_analysis_2<CurveKernel_2>}, \ccc{CKvA_} $>$\ccc{::type}, \ccc{CurveKernel_2} $>$, and \ccc{Curved_kernel_via_analysis_2_functors<boost::mpl::if_< boost::mpl::bool_< boost::is_void< CKvA_>::value} $>$, \ccc{Curved_kernel_via_analysis_2<CurveKernel_2>}, \ccc{CKvA_} $>$\ccc{::type}, \ccc{CurveKernel_2::Curve_analysis_2}, \ccc{boost::mpl::if_<boost::mpl::bool_< boost::is_void< Point_>::value} $>$, \ccc{CGAL::internal::Point_2_<boost::mpl::if_< boost::mpl::bool_< boost::is_void< CKvA_>::value} $>$, \ccc{Curved_kernel_via_analysis_2<CurveKernel_2>}, \ccc{CKvA_} $>$\ccc{::type} $>$, \ccc{Point_} $>$\ccc{::type}, \ccc{boost::mpl::if_<boost::mpl::bool_< boost::is_void< Arc_>::value} $>$, \ccc{CGAL::internal::Arc_2_<boost::mpl::if_< boost::mpl::bool_< boost::is_void< CKvA_>::value} $>$, \ccc{Curved_kernel_via_analysis_2<CurveKernel_2>}, \ccc{CKvA_} $>$\ccc{::type} $>$, \ccc{Arc_} $>$\ccc{::type} $>$
