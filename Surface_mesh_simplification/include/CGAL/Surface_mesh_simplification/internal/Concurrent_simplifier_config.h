...
#ifndef CGAL_SURFACE_MESH_SIMPLIFICATION_DETAIL_CONCURRENT_SIMPLIFIER_CONFIG_H
#define CGAL_SURFACE_MESH_SIMPLIFICATION_DETAIL_CONCURRENT_SIMPLIFIER_CONFIG_H
...
// class Concurrent_simplifier_config
/// Singleton containing config
class Concurrent_simplifier_config
{
  // Private constructor (singleton)
  Concurrent_simplifier_config()
  :
...
public:
  static Concurrent_simplifier_config &get()
  {
    static Concurrent_simplifier_config singleton;
    return singleton;
  }
...
#endif // CGAL_SURFACE_MESH_SIMPLIFICATION_DETAIL_CONCURRENT_SIMPLIFIER_CONFIG_H
