...
public:
  void swap(Self& other){
    std::swap(this->edge_facet_counter,other.edge_facet_counter);
    std::swap(this->m_number_of_facets,other.m_number_of_facets);
    this->triangulation().swap(other.triangulation());
  }
