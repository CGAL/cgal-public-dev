\begin{ccRefClass}{Nonnegative_linear_program_from_sparse_iterators<A_s_it, B_it, R_it, C_it>}
...
\ccConstructor{Nonnegative_linear_program_from_iterators(int n, int m, 
  ...
  The passed iterators are merely stored, no copying of the program 
