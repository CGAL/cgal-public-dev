...
\ccc{Nonnegative_linear_program_from_sparse_iterators<A_s_it, B_it, R_it, FL_it, L_it, FU_it, U_it, D_it, C_it>}\\
...
\ccc{Quadratic_program<NT>}\\
\ccc{Quadratic_program_from_mps<NT>}\\
\ccc{Nonnegative_linear_program_from_sparse_iterators<A_it, B_it, R_it, C_it>}\\
