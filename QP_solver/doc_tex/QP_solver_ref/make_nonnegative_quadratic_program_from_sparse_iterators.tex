\begin{ccRefFunction}{make_nonnegative_quadratic_program_from_sparse_iterators}

\ccInclude{CGAL/QP_models.h}

This template function creates an instance of 
\ccc{Nonnegative_quadratic_program_from_sparse_iterators<A_s_it, B_it, R_it, D_s_it, C_it>} from given iterators. This function can be useful if the types of these
...
{returns an instance of \ccc{Nonnegative_quadratic_program_from_sparse_iterators<A_s_it, B_it, R_it, D_it, C_it>}, constructed from the given iterators.}
