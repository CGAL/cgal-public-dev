...
#ifndef CGAL_VDL3_SVCET_33_COMPARE_Z_AT_XY_ABOVE_3
#define CGAL_VDL3_SVCET_33_COMPARE_Z_AT_XY_ABOVE_3
...
public:
  ...
  Compare_z_at_xy_above_3(const SVCET_3 *traits): Base(traits,true) {};
};
...
#endif // CGAL_VDL3_SVCET_33_COMPARE_Z_AT_XY_ABOVE_3
