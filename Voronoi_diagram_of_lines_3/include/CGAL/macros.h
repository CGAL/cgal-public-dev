...
// This files is basically a copy of 
// Algebraic_kernel_d/include/CGAL/Algebraic_kernel_d/flags.h      
// and is used for experiments with changing the original file. 

// Since the each macro is guarded, there is not specific include guard 
