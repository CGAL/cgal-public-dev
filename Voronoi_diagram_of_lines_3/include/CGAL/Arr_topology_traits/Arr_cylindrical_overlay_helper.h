...
//
// $URL: svn+ssh://hemmer@scm.gforge.inria.fr/svn/cgal/trunk/Arrangement_on_surface_2/include/CGAL/Arr_topology_traits/Arr_cylindrical_overlay_helper.h $
// $Id: Arr_cylindrical_overlay_helper.h 41118 2007-12-07 14:25:32Z efif $
// 
//
...
#ifndef CGAL_ARR_CYLINDRICAL_OVERLAY_HELPER_H
#define CGAL_ARR_CYLINDRICAL_OVERLAY_HELPER_H

/*! \file
 * Definition of the Arr_cylindrical_overlay_helper class-template.
 */
...
/*! \class Arr_cylindrical_overlay_helper
...
protected:
  ...
  //! Red cylindrical face
  Face_handle_red m_red_nf;

  //! Blue cylindrical face
  Face_handle_blue m_blue_nf;

public:
  /*! Constructor, given the input red and blue arrangements. */
  Arr_cylindrical_overlay_helper(const Arrangement_red_2 * red_arr,
  ...
  void before_sweep()
  {
    // Get the cylindrical faces in both arrangements.
    m_red_nf  = Face_handle_red(m_red_top_traits->cylindrical_face());
    m_blue_nf = Face_handle_blue(m_blue_top_traits->cylindrical_face());
    return;
  }
