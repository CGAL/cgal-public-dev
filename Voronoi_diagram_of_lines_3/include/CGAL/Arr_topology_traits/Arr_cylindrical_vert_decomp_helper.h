...
//
// $URL: svn+ssh://hemmer@scm.gforge.inria.fr/svn/cgal/trunk/Arrangement_on_surface_2/include/CGAL/Arr_topology_traits/Arr_cylindrical_vert_decomp_helper.h $
// $Id: Arr_cylindrical_vert_decomp_helper.h 41118 2007-12-07 14:25:32Z efif $
// 
// Author(s)     : Ron Wein <wein@post.tau.ac.il>
//                 Efi Fogel <efif@post.tau.ac.il>
//

#ifndef CGAL_ARR_CYLINDRICAL_VERT_DECOMP_HELPER_H
#define CGAL_ARR_CYLINDRICAL_VERT_DECOMP_HELPER_H

/*! \file
 * Definition of the Arr_cylindrical_vert_decomp_helper class-template.
 */
...
/*! \class Arr_cylindrical_vert_decomp_helper
...
public:
   ...
   */
  Arr_cylindrical_vert_decomp_helper(const Arrangement_2 *arr) :
...
void Arr_cylindrical_vert_decomp_helper<Tr, Arr>::before_sweep()
{
  ...
  m_north_face = Face_const_handle (m_top_traits->cylindrical_face());
...
template <class Tr, class Arr>
void
Arr_cylindrical_vert_decomp_helper<Tr, Arr>::after_handle_event (Event *event)
{
