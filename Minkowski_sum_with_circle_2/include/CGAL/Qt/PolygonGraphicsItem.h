...
//
// $URL: svn+ssh://rozapoga@scm.gforge.inria.fr/svn/cgal/trunk/GraphicsView/include/CGAL/Qt/PolygonGraphicsItem.h $
...
public:
  PolygonGraphicsItem(const P* p_);
...
template <typename P>
PolygonGraphicsItem<P>::PolygonGraphicsItem(const P * p_)
