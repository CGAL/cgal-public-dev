...
//
// $URL: svn+ssh://rozapoga@scm.gforge.inria.fr/svn/cgal/trunk/GraphicsView/include/CGAL/Qt/PolygonWithHolesGraphicsItem.h $
...
public:
  PolygonWithHolesGraphicsItem(const P* p_);
...
template <typename P>
PolygonWithHolesGraphicsItem<P>::PolygonWithHolesGraphicsItem(const P * p_)
