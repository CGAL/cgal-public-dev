...
//
// $URL: svn+ssh://rozapoga@scm.gforge.inria.fr/svn/cgal/trunk/Boolean_set_operations_2/include/CGAL/General_polygon_2.h $
...
public:
  ...
  Curve_iterator insert(const X_monotone_curve_2& cv)
  {
    return m_xcurves.insert(m_xcurves.end(), cv);
  }
