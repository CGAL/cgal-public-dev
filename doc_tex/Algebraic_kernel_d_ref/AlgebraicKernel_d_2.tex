...
A type that is used to represent real solutions of bivariate polynomial systems.
...
\ccNestedType{Compute_x_2}{A model of \ccc{AlgebraicKernel_d_2::ComputeX_2}.}
\ccNestedType{Compute_y_2}{A model of \ccc{AlgebraicKernel_d_2::ComputeY_2}.} 
