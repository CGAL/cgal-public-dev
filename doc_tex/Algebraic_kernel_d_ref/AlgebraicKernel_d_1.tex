...
\ccNestedType{Bound}{
A type to represent upper and lower bounds of \ccc{AlgebraicKernel_d_1::Algerbaic_real_1}\\
The type is \ccc{ExplicitInteroperable} with \ccc{AlgebraicKernel_d_1::Coefficient} and must 
be a model \ccc{IntegralDomain}, \ccc{RealEmbeddable} and dense $\R$.}
