...
#include <CGAL/Arr_torus_topology_traits_2.h>
...
protected:
  ...
  typedef Arr_torus_topology_traits_2 <Geometry_traits_2, Dcel >
                                                          Topology_traits_2;
public:
  typedef Arrangement_on_surface_2< Geometry_traits_2, Topology_traits_2 >
                                                          Base;

  typedef Arrangement_on_torus_2<Geometry_traits_2, Dcel> Self;
...
public:
  ...
  /*! Default constructor. */
  Arrangement_on_torus_2 () :
    Base ()
  {}

  /*! Copy constructor (from a base arrangement). */
  Arrangement_on_torus_2 (const Base& base) :
    Base (base)
  {}

  /*! Constructor given a traits object. */
  Arrangement_on_torus_2 (const Traits_2 *tr) :
    Base (tr)
  {}
  //@}
...
#endif // CGAL_ARRANGEMENT_ON_TORUS_2_H
