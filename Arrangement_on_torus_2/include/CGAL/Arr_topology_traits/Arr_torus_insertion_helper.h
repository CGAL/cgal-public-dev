...
#define CGAL_ARR_TORUS_INSERTION_HELPER_H 1

/*!\file include/CGAL/Arr_topology_traits/Arr_torus_insertion_helper.h
 * \brief Definition of the Arr_torus_insertion_helper class-template.
 */
...
#endif // CGAL_ARR_TORUS_INSERTION_HELPER_H
// EOF
