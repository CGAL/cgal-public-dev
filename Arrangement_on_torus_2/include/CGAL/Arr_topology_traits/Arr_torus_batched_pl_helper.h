...
#define CGAL_ARR_TORUS_BATCHED_PL_HELPER_H 1

/*!\file include/CGAL/Arr_topology_traits/Arr_torus_batched_pl_helper.h
 * \brief Definition of the Arr_torus_batched_pl_helper class-template.
 */
