...
#define CGAL_ARR_TORUS_TOPOLOGY_TRAITS_2_H 1

/*!\file include/CGAL/Arr_torus_topology_traits_2
 * \brief Definition of the Arr_torus_topology_traits_2<GeomTraits> 
 * class.
 */
...
protected:
    ...
    struct Point_2_less_NS {
        ...
        /*! Construct */    
        Point_2_less_NS(const Traits_adaptor_2 * traits) : 
            _m_traits(traits) {
        }
    ...
    struct Point_2_less_WE {
        ...
        /*! Construct */    
        Point_2_less_WE(const Traits_adaptor_2 * traits) : 
            _m_traits(traits) {
        }
...
#endif // CGAL_ARR_TORUS_TOPOLOGY_TRAITS_2_H
// EOF
