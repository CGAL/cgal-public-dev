...
class Segment_3_trajectory : public std::tuple<Point_3_trajectory<K>, Point_3_trajectory<K>> {
    ...
    using Point_3_trajectory = Point_3_trajectory<K>;
    using Base               = std::tuple<Point_3_trajectory, Point_3_trajectory>;

    public: 
        Segment_3_trajectory() {}

        Segment_3_trajectory(const Point_3_trajectory& source, const Point_3_trajectory& target)
        : Base(source, target)
        {}

        Segment_3_trajectory(Point_3_trajectory&& source, Point_3_trajectory&& target)
...
class Triangle_3_trajectory : public std::tuple<Point_3_trajectory<K>, Point_3_trajectory<K>, Point_3_trajectory<K>> {
    ...
    using Point_3_trajectory = Point_3_trajectory<K>;
    using Base               = std::tuple<Point_3_trajectory, Point_3_trajectory, Point_3_trajectory>;

    public: 
        Triangle_3_trajectory() {}

        Triangle_3_trajectory(const Point_3_trajectory& v0, const Point_3_trajectory& v1, const Point_3_trajectory& v2)
        : Base(v0, v1, v2)
        {}

        Triangle_3_trajectory(Point_3_trajectory&& v0, Point_3_trajectory&& v1, Point_3_trajectory&& v2)
