...
#ifndef CGAL_AABB_TRIANGLE_PAIR_PRIMITIVE_H
#define CGAL_AABB_TRIANGLE_PAIR_PRIMITIVE_H
...
template < class FaceGraph,
           ...
           class OneFaceGraphPerTree = Tag_false,
           class CacheDatum=Tag_false >
class AABB_face_graph_triangle_pair_primitive
