...
#ifndef CGAL_POLYGONAL_SURFACE_RECONSTRUCTION_TRAITS_H
#define CGAL_POLYGONAL_SURFACE_RECONSTRUCTION_TRAITS_H
...
namespace CGAL {
    ...
    /*!
      ...
      \brief %Default traits class to use the polygonal surface reconstruction class `Polygonal_surface_reconstruction`.
      \cgalModels `Polygonal_surface_reconstruction::Traits`
  ...
  struct Polygonal_surface_reconstruction_traits {
    ///
    ...
    ///
	Polygonal_surface_reconstruction_traits(const Gt& gt =  Gt())
      : m_gt(gt) {}
	...
	///
	typedef typename Point_set_with_segments<Gt> Point_set_with_segments;
	///
...
#endif // CGAL_POLYGONAL_SURFACE_RECONSTRUCTION_TRAITS_H
