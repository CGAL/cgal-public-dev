...
#ifndef CGAL_POLYGON_MESH_PROCESSING_POISSON_DISK_SAMPLING_H
#define CGAL_POLYGON_MESH_PROCESSING_POISSON_DISK_SAMPLING_H
...
int main(int argc, char* argv[])
{
 ...
 //CGAL_POLYGON_MESH_PROCESSING_POISSON_DISK_SAMPLING_H
