...
class Parameters { // rename TestParameterList
  ...
  Parameters(bool without_sm = false) // maybe child clase TestParameterListNoCGALMesher
  {
    if(without_sm)
    {
      Param p2 = {false,  true, false, true, false, true, false};
      Param p4 = {false,  true, true, false, false, true, false};
      Param p5 = {false,  true, false, false, true, true, false};
      Param p6 = {true,  false, false, true, false, true, false};
      Param p8 = {true,  false, true, false, false, true, false};
      Param p9 = {true,  false, false, false, true, true, false};
      ...
      paramList.push_back(p9);
    }

    else
    {
      Param p1 = {false,  true, false, true, false, false, true};
      Param p2 = {false,  true, false, true, false, true, false};
      Param p3 = {false,  true, true, false, false, false, true};
      Param p4 = {false,  true, true, false, false, true, false};
      Param p5 = {false,  true, false, false, true, false, true};
      Param p6 = {false,  true, false, false, true, true, false};
      Param p7 = {true,  false, false, true, false, false, true};
      Param p8 = {true,  false, false, true, false, true, false};
      Param p9 = {true,  false, true, false, false, false, true};
      Param p10 = {true,  false, true, false, false, true, false};
      Param p11 = {true,  false, false, false, true, false, true};
      Param p12 = {true,  false, false, false, true, true, false};
      ...
      paramList.push_back(p8);
      paramList.push_back(p9);
      paramList.push_back(p10);
      paramList.push_back(p11);
      paramList.push_back(p12);
    }
  }
