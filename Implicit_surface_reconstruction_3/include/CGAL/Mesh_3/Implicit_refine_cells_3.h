...
#ifndef CGAL_MESH_3_IMPLICIT_REFINE_CELLS_3_H
#define CGAL_MESH_3_IMPLICIT_REFINE_CELLS_3_H
...
template <class Tr,
          ...
          >
class Implicit_refine_tets_base :
    public Container,
...
public:
  ...
  Implicit_refine_tets_base(Tr& t, Criteria crit)
...
#  endif
  ...
  {
    std::cerr << "Implicit_refine_tets: before conflicts of " << p;
  }
#else
...
template <class Tr,
          ...
          class Container = Meshes::Double_map_container<
            ...
            typename Criteria::Cell_quality>
>
class Implicit_refine_tets_with_oracle_base
  : public Implicit_refine_tets_base<Tr,
                            Criteria,
                            Container>
{
public:
  typedef Implicit_refine_tets_base<Tr, Criteria, Container> Base;
  typedef Implicit_refine_tets_with_oracle_base<Tr,
                                       Criteria,
                                       Surface,
                                       Oracle,
                                       Container> Self;
  ...
  Implicit_refine_tets_with_oracle_base(Tr& t, Criteria crit, Surface& s, Oracle& o)
 ...
 Zone conflicts_zone_impl(const Point& p, Cell_handle c) const
  {
    ...
    if (triangulation_ref_impl().side_of_sphere(c, p, true) != ON_BOUNDED_SIDE)
      std::cerr << "Implicit_refine_tets_with_oracle_base::conflicts_zone_impl: ERROR: circumcenter out of sphere!\n";
#endif
...
}; // end Implicit_refine_tets_with_oracle_base
...
template <typename Tr,
          ...
          typename BaseP = // workaround for VC7, see below
             Implicit_refine_tets_with_oracle_base<Tr, Criteria, Surface, Oracle>,
          typename Facets_level = Refine_facets<Tr>
 >
class Implicit_refine_tets :
  public BaseP,
  public CGAL::Mesher_level <
    Tr,
    Implicit_refine_tets<Tr, Criteria, Surface, Oracle, BaseP, Facets_level>,
    typename Tr::Cell_handle,
    Facets_level,
...
public:
  typedef Implicit_refine_tets<Tr, Criteria, Surface, Oracle, Base, Facets_level> Self;
  typedef CGAL::Mesher_level <
    Tr,
    Implicit_refine_tets<Tr, Criteria, Surface, Oracle, Base, Facets_level>,
    typename Tr::Cell_handle,
    Facets_level,
    Triangulation_mesher_level_traits_3<Tr>
  > Mesher;

  Implicit_refine_tets(Tr& t, Criteria crit, Surface& surface, Oracle& oracle, Facets_level& facets_level)
...
}; // end class Implicit_refine_tets

} // end namespace Mesh_3
} // end namespace CGAL

#endif // CGAL_MESH_3_IMPLICIT_REFINE_CELLS_3_H
