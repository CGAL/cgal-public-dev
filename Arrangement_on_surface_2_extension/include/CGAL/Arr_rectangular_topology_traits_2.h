...
#ifndef CGAL_ARR_RECTANGULAR_TOPOLOGY_TRAITS_2_H
#define CGAL_ARR_RECTANGULAR_TOPOLOGY_TRAITS_2_H

/*! \file
 * The topology traits for great rectangular arcs embedded on a sphere for the
 * arrangement package.
 */
...
#include <CGAL/Arr_topology_traits/Arr_rectangular_construction_helper.h>
#include <CGAL/Arr_topology_traits/Arr_rectangular_insertion_helper.h>
#include <CGAL/Arr_topology_traits/Arr_rectangular_overlay_helper.h>
#include <CGAL/Arr_topology_traits/Arr_rectangular_batched_pl_helper.h>
#include <CGAL/Arr_topology_traits/Arr_rectangular_vert_decomp_helper.h>
...
public:
  ...
  typedef Arr_rectangular_topology_traits_2<Geometry_traits_2, Dcel>
                                                          Self;
  ...
  struct rebind
  {
    typedef Arr_rectangular_topology_traits_2<T,D> other;
  };
...
protected:
  ...
  //! The rectangular (bounded) face.  
  Face * m_rectangular_face;
  ...
  Arr_rectangular_topology_traits_2(const Self &);
...
public:
  ...
  /*! Default constructor. */
  Arr_rectangular_topology_traits_2();

  /*! Constructor with a geometry-traits class.
   * \param traits the traits.
   */
  Arr_rectangular_topology_traits_2(Geometry_traits_2 * traits);

  /*! Assign the contents of another topology-traits class.
   * \param other the other rectangular topology-traits.
   */
  ...
  /*! Obtain the rectangular face (const version). */
  const Face * rectangular_face() const
  {
    return m_rectangular_face;
  }

  /*! Obtain the rectangular face (non-const version). */
  ...
  {
    if (m_boundary_vertices.empty()) return m_rectangular_face;
...
private:
  ...
  typedef Arr_construction_event<Geometry_traits_2,CSubcurve,Arr>
                                                                CEvent;
  typedef Arr_rectangular_construction_helper<Geometry_traits_2,Arr,
  ...
  typedef Arr_rectangular_insertion_helper<BInsTraits,Arr,BIEvent,BISubcurve>
                                                                BIHelper;
  ...
  typedef Arr_rectangular_insertion_helper<InsTraits,Arr,IEvent,ISubcurve>
                                                                IHelper;
  ...
  typedef Arr_rectangular_batched_pl_helper<BplTraits, Arr>       BplHelper;
  ...
  typedef Arr_rectangular_vert_decomp_helper<VdTraits, Arr>       VdHelper;
  ...
  struct _Overlay_helper :
    public Arr_rectangular_overlay_helper<ExGeomTraits_, ArrangementA_,
  ...
  {
    typedef Arr_rectangular_overlay_helper<ExGeomTraits_, ArrangementA_,
      ArrangementB_, Arr, Arr_construction_event<ExGeomTraits_,
      Arr_overlay_subcurve<ExGeomTraits_>, Arr>,
...
//#include <CGAL/Arr_topology_traits/Arr_rectangular_topology_traits_2_impl.h>
