...
public:
    ...
    Parameter_space_in_x_2 parameter_space_in_x_2_object() const {
        return _m_ckva.parameter_space_in_x_2_object();
    }

    typedef typename CKvA_2::Parameter_space_in_y_2 Parameter_space_in_y_2;
    Parameter_space_in_y_2 parameter_space_in_y_2_object() const {
        return _m_ckva.parameter_space_in_y_2_object();
    }
  ...
  typedef typename CKvA_2::Make_x_monotone_2 Make_x_monotone_2;
    ...
    public:
        ...
        Construct_x_monotone_segment_2(const CKvA_2* kernel) : Base(kernel) {}
    ...
    private:
        ...
        std::pair<std::pair<int,int>, bool>
            ...
            for(int i = 0; i < status_line.number_of_events(); i++) {
              Point_2 curr_point(p.ckva(), x,cv,i);
    ...
    Construct_x_monotone_segment_2 construct_x_monotone_segment_2_object() 
        const {
        return Construct_x_monotone_segment_2(&_m_ckva);
    }
...
/*
    ...
    public:
        ...
        Construct_vertical_segment_2(const CKvA_2* kernel) : Base(kernel) {}
    ...
    Construct_vertical_segment_2 construct_vertical_segment_2_object() const {
        return Construct_vertical_segment_2(&_m_ckva);
    }
...
*/      
    ...
    public:
        ...
        Construct_curve_2(const CKvA_2* kernel) : Base(kernel) {}
    ...
    Construct_curve_2 construct_curve_2_object() const {
        return Construct_curve_2(&_m_ckva);
    }
