...
protected:
    ...
    const Curved_kernel_via_analysis_2 *_m_ckva;
...
public:
     ...
     */
    Construct_point_2(const Curved_kernel_via_analysis_2 *ckva) :
        Base(ckva) {
    }
    ...
    Point_2 operator()(const Coordinate_1& x, 
                       ...
                       int arcno) {
        Point_2 pt(Base::_ckva(), x, c, arcno);
        return pt;
    }
	...
	Point_2 pt(Base::_ckva(), x, a.curve(), a.arcno(x));
        return pt;
    }
...
public:
     ...
     * \param kernel The kernel
     */
    Construct_point_on_arc_2(const Curved_kernel_via_analysis_2 *ckva) :
        Base(ckva) {
    }
...
public:
     ...
     * \param kernel The kernel
     */
    Construct_arc_2(const Curved_kernel_via_analysis_2 *ckva) :
        Base(ckva) {
    }
    ...
    Arc_2 operator()(const Point_2& p, const Point_2& q, 
        ...
        Arc_2 arc(Base::_ckva(), p, q, c, arcno, arcno_p, arcno_q);
        return arc;
    }
    ...
    Arc_2 operator()(const Point_2& origin, CGAL::Arr_curve_end inf_end, 
        ...
        Arc_2 arc(Base::_ckva(), origin, inf_end, c, arcno, arcno_o);
        return arc;
    }
    ...
    Arc_2 operator()(const Point_2& origin, const Coordinate_1& asympt_x, 
                     ...
                     int arcno_o) {
        Arc_2 arc(Base::_ckva(), origin, asympt_x, inf_end, c, arcno, arcno_o);
        return arc;
    }
    ...
    Arc_2 operator()(const Coordinate_1& asympt_x1, 
                     ...
                     const Curve_analysis_2& c, int arcno) {
        Arc_2 arc(Base::_ckva(), 
                  asympt_x1, inf_end1, asympt_x2, inf_end2, c, arcno);
        return arc;
    }
    ...
    Arc_2 operator()(CGAL::Arr_curve_end inf_endx, 
                     ...
                     const Curve_analysis_2& c, int arcno) {
        Arc_2 arc(Base::_ckva(), inf_endx, asympt_x, inf_endy, c, arcno);
        return arc;
    }
    ...
    Arc_2 operator()(const Point_2& origin, CGAL::Arr_curve_end inf_end,
        ...
        Arc_2 arc(Base::_ckva(), origin, inf_end, c);
        return arc;
    }
...
public:
     ...
     * \param kernel The kernel
     */
    Is_vertical_2(const Curved_kernel_via_analysis_2 *ckva) :
        Base(ckva) {
    }
...
public:
     ...
     * \param kernel The kernel
     */
    Construct_min_vertex_2(const Curved_kernel_via_analysis_2 *ckva) :
        Base(ckva) {
    }
...
public:
     ...
     * \param kernel The kernel
     */
    Construct_max_vertex_2(const Curved_kernel_via_analysis_2 *ckva) :
        Base(ckva) {
    }
...
public:
     ...
     * \param kernel The kernel
     */
    Construct_interior_vertex_2(const Curved_kernel_via_analysis_2 *ckva) :
        Base(ckva) {
    }
  ...
  result_type operator()(const Arc_2& arc) const {
    ...
    result_type compute_interior_vertex(const Arc_2& arc) const {
      ...
      if (!arc.is_vertical())
      {
        ...
        Point_2 p = Base::_ckva()->construct_point_on_arc_2_object() 
      ...
      Curve_analysis_2 curve = 
        Base::_ckva()->kernel().construct_curve_2_object()(curve_poly);   
      Point_2 p = 
...
public:
     ...
     * \param kernel The kernel
     */
    Compare_x_2(const Curved_kernel_via_analysis_2 *ckva) :
        Base(ckva) {
    }
    ...
    result_type operator()(const Point_2 &p1, const Point_2 &p2) const {
      return Base::_ckva()->kernel().compare_1_object()
            (p1.x(), p2.x());
    }
};
...
public:
     ...
     * \param kernel The kernel
     */
    Compare_xy_2(const Curved_kernel_via_analysis_2 *ckva) :
        Base(ckva) {
    }
...
public:
     ...
     * \param kernel The kernel
     */
    Compare_y_at_x_2(const Curved_kernel_via_analysis_2 *ckva) :
        Base(ckva) {
    }
...
public:
     ...
     * \param kernel The kernel
     */
    Compare_y_at_x_left_2(const Curved_kernel_via_analysis_2 *ckva) :
        Base(ckva) {
    }
...
public:
     ...
     * \param kernel The kernel
     */
    Compare_y_at_x_right_2(const Curved_kernel_via_analysis_2 *ckva) :
        Base(ckva) {
    }
...
public:
     ...
     * \param kernel The kernel
     */
    Is_in_x_range_2(const Curved_kernel_via_analysis_2 *ckva) :
        Base(ckva) {
    }
...
public:
     ...
     * \param kernel The kernel
     */
    Equal_2(const Curved_kernel_via_analysis_2 *ckva) :
        Base(ckva) {
    }
     ...
     */
    result_type operator()(const Point_2& p1, const Point_2& p2) const {
      return (Base::_ckva()->compare_xy_2_object()(p1, p2) == 
              CGAL::EQUAL);
    }
...
public:
     ...
     * \param kernel The kernel
     */
    Do_overlap_2(const Curved_kernel_via_analysis_2 *ckva) :
        Base(ckva) {
    }
    ...
    bool operator()(const Arc_2& cv1, const Arc_2& cv2) const {
        ...
        if (cv1.is_vertical()) { // both arcs are vertical
            ...
            if (Base::_ckva()-> kernel().compare_1_object()(
                        cv1._minpoint().x(),
...
public:
     ...
     * \param kernel The kernel
     */
    Intersect_2(const Curved_kernel_via_analysis_2 *ckva) :
        Base(ckva) {
    }
...
public:
     ...
     * \param kernel The kernel
     */
    Trim_2(const Curved_kernel_via_analysis_2 *ckva) :
        Base(ckva) {
    }
...
public:
     ...
     * \param kernel The kernel
     */
    Split_2(const Curved_kernel_via_analysis_2 *ckva) :
        Base(ckva) {
    }
...
public:
     ...
     * \param kernel The kernel
     */
    Are_mergeable_2(const Curved_kernel_via_analysis_2 *ckva) :
        Base(ckva) {
    }
    ...
    bool operator()(const Arc_2& cv1, const Arc_2& cv2) const {
        ...
        if (cv1.is_vertical()) { // both arcs are vertical 
            ...
            for (int k = 0; k < cv_line.number_of_events(); k++) {
                ...
                typename Point_2::Coordinate_2
                  tmp(common.x(), cv1.curve(), k);
                if (Base::_ckva()->kernel().compare_xy_2_object()(
                        common.xy(), tmp) == 
                    CGAL::EQUAL) {
                    return false;
                }
...
public:
     ...
     * \param kernel The kernel
     */
    Merge_2(const Curved_kernel_via_analysis_2 *ckva) :
        Base(ckva) {
    }
...
public:
     ...
     * \param kernel The kernel
     */
    Is_on_2(const Curved_kernel_via_analysis_2 *ckva) :
        Base(ckva) {
    }
    ...
    result_type operator()(const Point_2& p, const Curve_analysis_2& c) const {
        result_type res = 
          (Base::_ckva()->kernel().sign_at_2_object()(c, p.xy())
             == CGAL::ZERO);
        return res;
    }
...
public:
     ...
     * \param kernel The kernel
     */
    Make_x_monotone_2(const Curved_kernel_via_analysis_2 *ckva) :
        Base(ckva) {
    } 
...
public:
     ...
     * \param kernel The kernel
     */
    Parameter_space_in_x_2(const Curved_kernel_via_analysis_2 *ckva) :
        Base(ckva) {
    }
...
public:
     ...
     * \param kernel The kernel
     */
    Compare_y_near_boundary_2(const Curved_kernel_via_analysis_2 *ckva) :
        Base(ckva) {
    }
...
public:
     ...
     * \param kernel The kernel
     */
    Parameter_space_in_y_2(const Curved_kernel_via_analysis_2 *ckva) :
        Base(ckva) {
    }
...
public:
    ...
    Compare_x_near_boundary_2(const Curved_kernel_via_analysis_2 *ckva) :
        Base(ckva) {
    }
    ...
    result_type operator()(const Point_2& p, const Arc_2& cv,
        ...
        CGAL::Comparison_result res = 
            Base::_ckva()->kernel().compare_1_object()(
    ...
    result_type operator()(const Arc_2& cv1, CGAL::Arr_curve_end ce1,
        ...
        if (cv1.is_singular() && cv1.is_singular()) {
            ...
            res = Base::_ckva()->kernel().compare_1_object()(
                    cv1.curve_end_x(ce1),
                    cv2.curve_end_x(ce2)
            );
...
public:
     ...
     * \param kernel The kernel
     */
    Compare_endpoints_xy_2(const Curved_kernel_via_analysis_2 *ckva) :
        Base(ckva) {
    }
...
public:
     ...
     * \param kernel The kernel
     */
    Construct_opposite_2(const Curved_kernel_via_analysis_2 *ckva) :
        Base(ckva) {
    }
...
public:
     ...
     * \param kernel The kernel
     */
    X_extreme_points_2(const Curved_kernel_via_analysis_2 *ckva) :
        Base(ckva) {
    } 
...
public:
     ...
     * \param kernel The kernel
     */
    Y_extreme_points_2(const Curved_kernel_via_analysis_2 *ckva) :
        Base(ckva) {
    } 
...
#define CGAL_CKvA_2_functor_pred(Y, Z) \
    ...
    Curved_kernel_via_analysis_2_Functors::Y< Curved_kernel_via_analysis_2 \
        > Y; \
    Y Z() const { return Y(static_cast< const Curved_kernel_via_analysis_2* >(this)); }
