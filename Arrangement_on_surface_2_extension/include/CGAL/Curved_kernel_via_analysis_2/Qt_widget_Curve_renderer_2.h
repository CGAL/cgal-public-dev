...
//
// $URL: svn+ssh://asm@scm.gforge.inria.fr/svn/cgal/branches/features/Symbolic-mpi/Arrangement_on_surface_2/include/CGAL/Curved_kernel_via_analysis_2/Qt_widget_Curve_renderer_2.h $
// $Id: Qt_widget_Curve_renderer_2.h 59002 2010-10-04 11:00:27Z lrineau $
//
...
#define CGAL_REND_PT_RADIUS 3 

/*! \brief
 * outputs a curve arc to \c Qt_widget
 */
template <class LCA_2>
Qt_widget& operator << (Qt_widget& ws, 
            const Lite_arc_2< LCA_2 >& arc) {
    
    typedef Curve_renderer_facade<LCA_2> Facade;
