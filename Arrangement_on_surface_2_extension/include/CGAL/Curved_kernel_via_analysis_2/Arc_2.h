...
public:
    ...
    Arc_2_rep(const Curved_kernel_via_analysis_2* ckva,
              const Point_2& p, const Point_2& q, const Curve_analysis_2& c, 
...
public:
    ...
    protected:
        ...
        void copy_members(const Self& arc, New_rep& newrep) {
            ...
            newrep._m_ckva = arc.ptr()->_m_ckva;
...
public:
     ...
     *
     */
    Arc_2(const Curved_kernel_via_analysis_2* ckva, 
          const Point_2& p, const Point_2& q, const Curve_analysis_2& c,
          int arcno, int arcno_p, int arcno_q) : 
        Base(Rep(ckva, p, q, c, arcno, arcno_p, arcno_q)) { 
        
        CGAL_precondition(!p.is_identical(q));
        CGAL_precondition(
            this->ckva()->compare_x_2_object()(p,q) != CGAL::EQUAL
        );
   ...
   /*!\brief
    ...
    Arc_2(const Curved_kernel_via_analysis_2* ckva, 
        ...
        Base(Rep(ckva, 
                 origin, 
                 Point_2(ckva, inf_end, c, arcno), c, arcno, arcno_o)) {
     ...
     */
    Arc_2(const Curved_kernel_via_analysis_2* ckva, 
          const Point_2& origin, const Coordinate_1& asympt_x, 
          CGAL::Arr_curve_end inf_end, const Curve_analysis_2& c, int arcno,
          int arcno_o) :
      Base(Rep(ckva, origin, 
               Point_2(ckva, asympt_x, c, inf_end), c, arcno, arcno_o)) {
        
        CGAL_precondition(
            this->ckva()->kernel().compare_1_object()(origin.x(), asympt_x) 
            != CGAL::EQUAL
        );
        CGAL_precondition(arcno >= 0);
        CGAL_precondition(arcno_o >= 0);
    ...
    Arc_2(const Curved_kernel_via_analysis_2* ckva, 
        ...
        Base(Rep(ckva,
                 Point_2(ckva, CGAL::ARR_MIN_END, c, arcno),
                 Point_2(ckva, CGAL::ARR_MAX_END, c, arcno), c, arcno)) {
     ...
     */
    Arc_2(const Curved_kernel_via_analysis_2* ckva, 
          const Coordinate_1& asympt_x1, CGAL::Arr_curve_end inf_end1, 
          const Coordinate_1& asympt_x2, CGAL::Arr_curve_end inf_end2,
          const Curve_analysis_2& c, int arcno) :
        Base(Rep(ckva, 
                 Point_2(ckva, asympt_x1, c, inf_end1), 
                 Point_2(ckva, asympt_x2, c, inf_end2),
                 c, arcno)) {

        CGAL_precondition(
            this->ckva()->kernel().compare_1_object()(asympt_x1, asympt_x2) 
            != CGAL::EQUAL);
        CGAL_precondition(arcno >= 0);
        _fix_curve_ends_order();
    }
     ...
     */ 
    Arc_2(const Curved_kernel_via_analysis_2* ckva, 
          CGAL::Arr_curve_end inf_endx, const Coordinate_1& asympt_x,
          CGAL::Arr_curve_end inf_endy, const Curve_analysis_2& c, int arcno) :
        Base(Rep(ckva,
                 Point_2(ckva, inf_endx, c, arcno), 
                 Point_2(ckva, asympt_x, c, inf_endy), c, arcno)) {
...
public:
    ...
    Arc_2(const Curved_kernel_via_analysis_2* ckva, 
          const Point_2& p, const Point_2& q, const Curve_analysis_2& c) : 
        Base(Rep(ckva, p, q, c, -1, -1, -1, true)) {  
        ...
        CGAL_precondition(
            this->ckva()->compare_xy_2_object()(p, q, true) != CGAL::EQUAL
        );
    ...
    Arc_2(const Curved_kernel_via_analysis_2* ckva, 
        ...
        Base(Rep(ckva, origin, Point_2(ckva, origin.x(), c, inf_end), 
                 c, -1, -1, -1, true)) {
     ...
     */
    Arc_2(const Curved_kernel_via_analysis_2* ckva, 
          const Coordinate_1& x, const Curve_analysis_2& c) :
        Base(Rep(ckva,
                 Point_2(ckva, x, c, CGAL::ARR_MIN_END), 
                 Point_2(ckva, x, c, CGAL::ARR_MAX_END), 
                 c, -1, -1, -1, true)) {
...
#define CGAL_CKvA_2_GRAB_CK_FUNCTOR_FOR_ARC(X, Y) \
    typename Curved_kernel_via_analysis_2::X Y = this->ckva()->Y##_object(); \

public:
  //!\name Kernel
  //!@{

  //! return pointer to ckva
  const Curved_kernel_via_analysis_2* ckva() const {
...
public:
    ...
    int arcno(const Coordinate_1& x0) const {
        ...
        if (this->ptr()->_m_arcno_min != this->ptr()->_m_arcno && 
            ...
            this->ckva()->kernel().compare_1_object()(x0, _minpoint().x()) == 
            CGAL::EQUAL) {
            return this->ptr()->_m_arcno_min;
        }
        if (this->ptr()->_m_arcno_max != this->ptr()->_m_arcno && 
            is_finite(CGAL::ARR_MAX_END) &&
            this->ckva()->kernel().compare_1_object()(x0, _maxpoint().x()) == 
            CGAL::EQUAL) {
...
public:    
    ...
    bool is_in_x_range(const Coordinate_1& x, 
        ...
        if (min_has_x) {
            resmin = 
              this->ckva()->kernel().compare_1_object()(x, _minpoint().x());
        ...
        if (max_has_x) {
            resmax = 
              this->ckva()->kernel().compare_1_object()(x, _maxpoint().x());
    ...
    int multiplicity_of_intersection(
        ...
        Curve_pair_analysis_2 cpa_2 =
          this->ckva()->kernel().construct_curve_pair_2_object()
          (curve(), cv2.curve());
  ...
  /*!\brief
    ...
    static bool simplify(const Kernel_arc_2& cv, const Coordinate_2& p) {
        ...
        if (cv.ckva()->kernel().decompose_2_object()(
                    cv.curve(), p.curve(), 
            ...
            if (parts_of_f.size() == 1) {
                cv._simplify_by(
                    cv.ckva()->kernel().construct_curve_pair_2_object()
    ...
    static bool simplify(const Kernel_arc_2& cv1, const Kernel_arc_2& cv2) {
        ...
        if (cv1.ckva()->kernel().decompose_2_object()(
                    cv1.curve(), cv2.curve(), 
                    std::back_inserter(parts_of_f), 
                    std::back_inserter(parts_of_g),
                    std::back_inserter(common))) {
            ...
            if (parts_of_f.size() == 1) {
              cv1._simplify_by(
                  cv1.ckva()->kernel().construct_curve_pair_2_object()
                  (parts_of_f[0], common[0]));
            }
            if (parts_of_g.size() == 1) {
              cv2._simplify_by(
...
public:
    ...
    bool trim_by_arc(const Kernel_arc_2& cv2, Kernel_arc_2& trimmed1,
        ...
        typename Curve_kernel_2::Compare_1 compare_x(
            this->ckva()->kernel().compare_1_object()
        );
    ...
    void _check_pt_arcno_and_coprimality(const Point_2& pt, int arcno_on_c, 
        ...
        if (!c.is_identical(pt.curve())) {
            ...
            if (arcno_on_c != -1) {
                ...
                Curve_pair_analysis_2 cpa_2 =
                  this->ckva()->kernel().
                  construct_curve_pair_2_object()(pt.curve(), c);
            ...
            CGAL_precondition(!this->ckva()->kernel().decompose_2_object()(
                                  c, pt.curve(),
    ...
    void _check_arc_interior() const {
        ...
        if(is_vertical()) {
            ...
            typename Curve_kernel_2::Compare_xy_2 cmp_xy(
                this->ckva()->kernel().compare_xy_2_object());
        ...
        const typename Curved_kernel_via_analysis_2::
          ...
          this->ckva()->interval_arcno_cache();
    ...
    CGAL::Comparison_result _same_arc_compare_xy(
        ...
        if (!equal_x || only_x) {
            ...
            if (!p.is_on_left_right() && !q.is_on_left_right()) {
                ...
                res = this->ckva()->compare_x_2_object()(p, q);
                if (res != CGAL::EQUAL) {
                    CERR("result2: " << res << "\n");
                    return res;
                }
        ...
        if (locp == locq) {
            ...
            res = this->ckva()->compare_xy_2_object()(p, q, true);
            CERR("result9: " << res << "\n");
            return res;
        }
...
protected:
    ...
    bool _trim_if_overlapped(const Kernel_arc_2& cv2, OutputIterator oi) const
    {
        ...
        if (is_vertical()) { // here process vertical case
            ...
            if (this->ckva()->compare_x_2_object()(
                    _minpoint(),
        ...
        if (!this->ckva()->kernel().decompose_2_object()(
                    curve(), cv2.curve(), 
        ...
        for (it_com = common.begin(); it_com != common.end(); it_com++) {
            for(it_parts = parts_f.begin(); it_parts != parts_f.end(); 
                ...
                cpa_2 = this->ckva()->kernel().construct_curve_pair_2_object()
                  (*it_com, *it_parts);
    ...
    bool _joint_x_range(const Kernel_arc_2& cv2, Point_2& pt_low, 
        ...
        if (pt1.location() != CGAL::ARR_LEFT_BOUNDARY) {
            if (pt2.location() != CGAL::ARR_LEFT_BOUNDARY) {
                low = (this->ckva()->compare_x_2_object()(pt1, pt2) == 
                       CGAL::LARGER ? pt1 : pt2); 
            } else {
                low = pt1;
            }
        ...
        if (pt1.location() != CGAL::ARR_RIGHT_BOUNDARY) {
            if(pt2.location() != CGAL::ARR_RIGHT_BOUNDARY) {
                high = (this->ckva()->compare_x_2_object()(pt1, pt2) == 
        ...
        if (!low.is_on_left_right() && !high.is_on_left_right() &&
            this->ckva()->compare_x_2_object()(low, high) != 
    ...
    static OutputIterator _intersect_coprime_support(const Kernel_arc_2& cv1, 
        ...
        if (cv1.is_vertical() || cv2.is_vertical()) {
            ...
            typename Curved_kernel_via_analysis_2:: Construct_point_on_arc_2
              ...
              cv1.ckva()->construct_point_on_arc_2_object();
        ...
        Curve_pair_analysis_2 cpa_2 =
          cv1.ckva()->kernel().construct_curve_pair_2_object()(f, g);
        int low_idx = 0,       
  ...
  std::pair<double,double> y_interval_for_curve_end(
    ...
    case(CGAL::ARR_RIGHT_BOUNDARY): {
      ...
      if (CGAL::assign(ps, obj)) {
        ...
        y_approx = 
          this->ckva()->kernel().approximate_absolute_1_object()(
              asym_info, prec
          );
      }
      break;
    ...
    case (CGAL::ARR_INTERIOR): {
      ...
      y_approx = 
        this->ckva()->kernel().approximate_absolute_y_2_object()(
    ...
    CGAL::Bbox_2 bbox() const {
      if (!this->ptr()->_m_bbox) {
        ...
        if (!this->is_vertical()) {
          ...
          std::cout << "arCtraits: " << &(*(this->ckva())) << std::endl;
          std::cout << "arCkernel: " << &((this->ckva()->kernel())) << std::endl;
          std::cout << "arCcache : " << &((this->ckva()->kernel().curve_cache_2())) << std::endl;

          // TODO can this->curve()->polynomial be not squarefree?
          this->ckva()->kernel().solve_2_object()(
                this->curve(),
                this->ckva()->kernel().construct_curve_2_object()(
          ...
          for (int i = 0; i < n; i++) {
            ...
            if (this->is_in_x_range_interior(curr_xy.x())) {
              ...
              Point_2 curr_pt = 
                this->ckva()->construct_point_2_object()(curr_xy.x(), 
                                                   curr_xy.curve(),
                                                   curr_xy.arcno());
