...
//
// $URL: svn+ssh://asm@scm.gforge.inria.fr/svn/cgal/branches/features/Symbolic-mpi/Arrangement_on_surface_2/include/CGAL/Curved_kernel_via_analysis_2/Curve_renderer_facade.h $
// $Id: Curve_renderer_facade.h 59002 2010-10-04 11:00:27Z lrineau $
//
...
template <class LiteCurveAnalysis_2, class Float_>
...
public:
    ...
    typedef Curve_renderer_interface< LiteCurveAnalysis_2,
...
Lexit:  std::cerr << "Sorry, this does not work even with exact "
        ...
        std::cerr << "polynomial: " << renderer().polynomial_2() <<
            std::endl;
