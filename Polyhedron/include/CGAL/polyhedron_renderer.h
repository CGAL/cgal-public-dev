...
#define CGAL_POLY_TYPE CGAL::Polyhedron_3<PolyhedronTraits_3, PolyhedronItems_3, T_HDS, Alloc>
    ...
    public:
        Polyhedron_renderer(QVulkanWindow* w) : m_window(w), m_buff(nullptr), m_buffMem(nullptr), m_descPool(nullptr), m_descSetLayout(nullptr), m_pipeline(nullptr), m_devFuncs(nullptr), m_pipelineCache(nullptr), m_pipelineLayout(nullptr), m_proj(QMatrix4x4()), m_rotation(0.0f), m_descSet(), m_uniformBufferInfo() {}
        ...
        //void geoData(CGAL_POLY_TYPE& apoly) {
