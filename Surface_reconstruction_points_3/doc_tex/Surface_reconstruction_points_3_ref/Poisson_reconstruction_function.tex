...
If \eigen\ 3.1 (or greater) is available and \ccc{CGAL_USE_EIGEN3} is defined, an overload with \ccc{Eigen_solver_traits<Eigen::ConjugateGradient<Eigen_sparse_symmetric_matrix<double>::EigenType> >}
