/****************************************************************************
 ...
 This file is part of a fork of the QVulkanViewer library version 2.7.0.
...
namespace CGAL {
    ...
    CGAL_INLINE_FUNCTION
        QList<CGAL::QVulkanViewer*>& CGAL::QVulkanViewer::QVulkanViewerPool() {
        static QList<CGAL::QVulkanViewer*> QVulkanViewerPool_;
        void* p = qApp->property("qvulkanviewer pool").value<void*>();
        if (p == 0) {
            p = (void*)(&QVulkanViewerPool_);
            qApp->setProperty("qvulkanviewer pool", QVariant::fromValue(p));
        }
        return *static_cast<QList<CGAL::QVulkanViewer*> *>(p);
    }

    /*! \mainpage

    libCGAL::QVulkanViewer is a free C++ library based on Qt that enables the quick creation
    ...
    libCGAL::QVulkanViewer is <i>not</i> a 3D viewer that can be used directly to view 3D
    scenes in various formats. It is more likely to be the starting point for the
    coding of such a viewer.

    libCGAL::QVulkanViewer is based on the Qt toolkit and hence compiles on any architecture
    ...
    CGAL_INLINE_FUNCTION
        void CGAL::QVulkanViewer::defaultConstructor() {
        setFocusPolicy(::Qt::StrongFocus);

        CGAL::QVulkanViewer::QVulkanViewerPool().append(this);
    ...
    CGAL_INLINE_FUNCTION
        CGAL::QVulkanViewer::QVulkanViewer(QWidget* parent,
        ...
        m_window->setDeviceExtensions(QByteArrayList() << "VK_EXT_line_rasterization");
        m_window->setVulkanInstance(&m_inst);
        m_renderer = m_window->getRenderer();
        defaultConstructor();
    }

    /*CGAL_INLINE_FUNCTION
        CGAL::QVulkanViewer::QVulkanViewer(QWidget* parent, ::Qt::WindowFlags flags, VulkanWindow* w)
        : QWidget(parent, flags), m_window(w) {
    ...
    CGAL_INLINE_FUNCTION
        CGAL::QVulkanViewer::QVulkanViewer(QOpenGLContext* context, QWidget* parent,
            ::Qt::WindowFlags flags)
        : QWidget(parent, flags) {
        defaultConstructor();
    ...
    The viewer is replaced by \c nullptr in the QVulkanViewerPool() (in order to preserve
    ...
    CGAL_INLINE_FUNCTION
        CGAL::QVulkanViewer::~QVulkanViewer() {
        CGAL::QVulkanViewer::QVulkanViewerPool().removeAll(this);
    ...
    */
    CGAL_INLINE_FUNCTION
        void CGAL::QVulkanViewer::initializeGL() {
        if (!is_sharing)
        {
        ...
        //connect(context(), &QOpenGLContext::aboutToBeDestroyed, this, &CGAL::QVulkanViewer::contextIsDestroyed);
    ...
    CGAL_INLINE_FUNCTION
        void CGAL::QVulkanViewer::paintGL() {
    ...
    CGAL_INLINE_FUNCTION
        void CGAL::QVulkanViewer::preDraw() {
        //glClear(GL_COLOR_BUFFER_BIT | GL_DEPTH_BUFFER_BIT);
    ...
    method. */
    CGAL_INLINE_FUNCTION
        void CGAL::QVulkanViewer::postDraw() {
    ...
    CGAL_INLINE_FUNCTION
        void CGAL::QVulkanViewer::fastDraw() { draw(); }
    ...
    CGAL_INLINE_FUNCTION
        void CGAL::QVulkanViewer::setCameraIsEdited(bool edit) {
    ...
    CGAL_INLINE_FUNCTION
        void CGAL::QVulkanViewer::setDefaultShortcuts() {
    ...
    CGAL_INLINE_FUNCTION
        void CGAL::QVulkanViewer::setDefaultMouseBindings() {
    ...
    removed. */
    CGAL_INLINE_FUNCTION
        void CGAL::QVulkanViewer::setCamera(qglviewer::Camera* const camera) {
        if (!camera)
            return;
    ...
    CGAL_INLINE_FUNCTION
        void CGAL::QVulkanViewer::connectAllCameraKFIInterpolatedSignals(bool connection) {
    ...
    CGAL_INLINE_FUNCTION
        void CGAL::QVulkanViewer::drawLight(GLenum, qreal) const {
    }

#if (QT_VERSION >= QT_VERSION_CHECK(5, 4, 0))
    CGAL_INLINE_FUNCTION
        void CGAL::QVulkanViewer::renderText(int x, int y, const QString& str,
            const QFont& font) {
    ...
    CGAL_INLINE_FUNCTION
        void CGAL::QVulkanViewer::renderText(double x, double y, double z, const QString& str,
            const QFont& font) {
    ...
    */
    CGAL_INLINE_FUNCTION
        void CGAL::QVulkanViewer::drawText(int x, int y, const QString& text, const QFont& fnt) {
        if (!textIsEnabled())
            return;
    ...
    CGAL_INLINE_FUNCTION
        void CGAL::QVulkanViewer::displayMessage(const QString& message, int delay) {
        message_ = message;
    ...
    CGAL_INLINE_FUNCTION
        void CGAL::QVulkanViewer::hideMessage() {
        displayMessage_ = false;
        if (textIsEnabled())
            update();
    }
    ...
    CGAL_INLINE_FUNCTION
        void CGAL::QVulkanViewer::displayFPS() {
        drawText(10,
    ...
    CGAL_INLINE_FUNCTION
        void CGAL::QVulkanViewer::startScreenCoordinatesSystem(bool) const {
    }
    ...
    GL_MODELVIEW. */
    CGAL_INLINE_FUNCTION
        void CGAL::QVulkanViewer::stopScreenCoordinatesSystem() const {
    }
    ...
    CGAL_INLINE_FUNCTION
        void CGAL::QVulkanViewer::timerEvent(QTimerEvent*) {
    ...
    CGAL_INLINE_FUNCTION
        void CGAL::QVulkanViewer::startAnimation() {
    ...
    CGAL_INLINE_FUNCTION
        void CGAL::QVulkanViewer::stopAnimation() {
    ...
    mechanism and you did not overload CGAL::QVulkanViewer. If you choose to derive your own
    ...
    This method is called when you use the CGAL::QVulkanViewer::SELECT mouse binding(s)
    (default is Shift + left button). Use setMouseBinding() to change this. */
    CGAL_INLINE_FUNCTION
        void CGAL::QVulkanViewer::select(const QMouseEvent* event) {
    ...
    It is called when the user clicks on the CGAL::QVulkanViewer::SELECT
    CGAL::QVulkanViewer::ClickAction binded button(s) (default is Shift + LeftButton).
    ...
    CGAL_INLINE_FUNCTION
        void CGAL::QVulkanViewer::select(const QPoint& point) {
        beginSelection(point);
        drawWithNames();
        endSelection(point);
        postSelection(point);
    ...
    */
    CGAL_INLINE_FUNCTION
        void CGAL::QVulkanViewer::beginSelection(const QPoint& point)
    {
    ...
    CGAL_INLINE_FUNCTION
        void CGAL::QVulkanViewer::endSelection(const QPoint& point) {
        Q_UNUSED(point);
    ...
    CGAL_INLINE_FUNCTION
        void CGAL::QVulkanViewer::setSelectBufferSize(int size) {
        if (selectBuffer_)
            delete[] selectBuffer_;
    ...
    static QString mouseButtonsString2(::Qt::MouseButtons b) {
        QString result("");
        bool addAmpersand = false;
        if (b & ::Qt::LeftButton) {
            result += CGAL::QVulkanViewer::tr("Left", "left mouse button");
            addAmpersand = true;
        }
        if (b & ::Qt::MiddleButton) {
            if (addAmpersand)
                result += " & ";
            result += CGAL::QVulkanViewer::tr("Middle", "middle mouse button");
            addAmpersand = true;
        }
        if (b & ::Qt::RightButton) {
            if (addAmpersand)
                result += " & ";
            result += CGAL::QVulkanViewer::tr("Right", "right mouse button");
        }
        return result;
    }

    CGAL_INLINE_FUNCTION
        void CGAL::QVulkanViewer::performClickAction(qglviewer::ClickAction ca, const QMouseEvent* const e) {
    ...
    CGAL_INLINE_FUNCTION
        void CGAL::QVulkanViewer::mousePressEvent(QMouseEvent* e) {
    ...
    if ((e->button() == myButton) && (e->modifiers() == myModifiers))
      ...
      CGAL::QVulkanViewer::mousePressEvent(e);
    }
    ...
    if (myMouseBehavior)
      ...
      CGAL::QVulkanViewer::mouseMoveEvent(e);
    }
    ...
    if (myMouseBehavior)
      ...
      CGAL::QVulkanViewer::mouseReleaseEvent(e);
    }
    \endcode */
    CGAL_INLINE_FUNCTION
        void CGAL::QVulkanViewer::mouseMoveEvent(QMouseEvent* e) {
        if (mouseGrabber()) {
    ...
    customization. */
    CGAL_INLINE_FUNCTION
        void CGAL::QVulkanViewer::mouseReleaseEvent(QMouseEvent* e) {
        if (mouseGrabber()) {
            if (mouseGrabberIsAManipulatedCameraFrame_)
                (dynamic_cast<qglviewer::ManipulatedFrame*>(mouseGrabber()))
    ...
    CGAL_INLINE_FUNCTION
        void CGAL::QVulkanViewer::wheelEvent(QWheelEvent* e) {
    ...
    CGAL_INLINE_FUNCTION
        void CGAL::QVulkanViewer::mouseDoubleClickEvent(QMouseEvent* e) {
        //#CONNECTION# mousePressEvent has the same structure
    ...
    If the CGAL::QVulkanViewer is embedded in an other QWidget (see
    CGAL_INLINE_FUNCTION
    QWidget::topLevelWidget()), this widget is displayed in full screen instead. */
    CGAL_INLINE_FUNCTION
        void CGAL::QVulkanViewer::setFullScreen(bool fullScreen) {
    ...
    CGAL_INLINE_FUNCTION
        void CGAL::QVulkanViewer::setMouseGrabber(qglviewer::MouseGrabber* mouseGrabber) {
    ...
    CGAL_INLINE_FUNCTION
        void CGAL::QVulkanViewer::setMouseGrabberIsEnabled(
    ...
    CGAL_INLINE_FUNCTION
        QString CGAL::QVulkanViewer::mouseActionString(qglviewer::MouseAction ma) {
        switch (ma) {
        case CGAL::qglviewer::NO_MOUSE_ACTION:
            return QString();
        case CGAL::qglviewer::ROTATE:
            return CGAL::QVulkanViewer::tr("Rotates", "ROTATE mouse action");
        case CGAL::qglviewer::ZOOM:
            return CGAL::QVulkanViewer::tr("Zooms", "ZOOM mouse action");
        case CGAL::qglviewer::TRANSLATE:
            return CGAL::QVulkanViewer::tr("Translates", "TRANSLATE mouse action");
        case CGAL::qglviewer::MOVE_FORWARD:
            return CGAL::QVulkanViewer::tr("Moves forward", "MOVE_FORWARD mouse action");
        case CGAL::qglviewer::LOOK_AROUND:
            return CGAL::QVulkanViewer::tr("Looks around", "LOOK_AROUND mouse action");
        case CGAL::qglviewer::MOVE_BACKWARD:
            return CGAL::QVulkanViewer::tr("Moves backward", "MOVE_BACKWARD mouse action");
        case CGAL::qglviewer::SCREEN_ROTATE:
            return CGAL::QVulkanViewer::tr("Rotates in screen plane",
                "SCREEN_ROTATE mouse action");
        case CGAL::qglviewer::ROLL:
            return CGAL::QVulkanViewer::tr("Rolls", "ROLL mouse action");
        case CGAL::qglviewer::DRIVE:
            return CGAL::QVulkanViewer::tr("Drives", "DRIVE mouse action");
        case CGAL::qglviewer::SCREEN_TRANSLATE:
            return CGAL::QVulkanViewer::tr("Horizontally/Vertically translates",
                "SCREEN_TRANSLATE mouse action");
        case CGAL::qglviewer::ZOOM_ON_REGION:
            return CGAL::QVulkanViewer::tr("Zooms on region for", "ZOOM_ON_REGION mouse action");
        case CGAL::qglviewer::ZOOM_FOV:
            return CGAL::QVulkanViewer::tr("Changes the FOV to emulate an optical zoom for ", "ZOOM_FOV mouse action");
        }
        return QString();
    }

    CGAL_INLINE_FUNCTION
        QString CGAL::QVulkanViewer::clickActionString(CGAL::qglviewer::ClickAction ca) {
        switch (ca) {
        case CGAL::qglviewer::NO_CLICK_ACTION:
            return QString();
        case CGAL::qglviewer::ZOOM_ON_PIXEL:
            return CGAL::QVulkanViewer::tr("Zooms on pixel", "ZOOM_ON_PIXEL click action");
        case CGAL::qglviewer::ZOOM_TO_FIT:
            return CGAL::QVulkanViewer::tr("Zooms to fit scene", "ZOOM_TO_FIT click action");
        case CGAL::qglviewer::SELECT:
            return CGAL::QVulkanViewer::tr("Selects", "SELECT click action");
        case CGAL::qglviewer::RAP_FROM_PIXEL:
            return CGAL::QVulkanViewer::tr("Sets pivot point", "RAP_FROM_PIXEL click action");
        case CGAL::qglviewer::RAP_IS_CENTER:
            return CGAL::QVulkanViewer::tr("Resets pivot point", "RAP_IS_CENTER click action");
        case CGAL::qglviewer::CENTER_FRAME:
            return CGAL::QVulkanViewer::tr("Centers manipulated frame",
                "CENTER_FRAME click action");
        case CGAL::qglviewer::CENTER_SCENE:
            return CGAL::QVulkanViewer::tr("Centers scene", "CENTER_SCENE click action");
        case CGAL::qglviewer::SHOW_ENTIRE_SCENE:
            return CGAL::QVulkanViewer::tr("Shows entire scene",
                "SHOW_ENTIRE_SCENE click action");
        case CGAL::qglviewer::ALIGN_FRAME:
            return CGAL::QVulkanViewer::tr("Aligns manipulated frame",
                "ALIGN_FRAME click action");
        case CGAL::qglviewer::ALIGN_CAMERA:
            return CGAL::QVulkanViewer::tr("Aligns camera", "ALIGN_CAMERA click action");
        }
        return QString();
    }

    static QString keyString2(unsigned int key) {
    ...
    CGAL_INLINE_FUNCTION
        QString CGAL::QVulkanViewer::formatClickActionPrivate(ClickBindingPrivate cbp) {
        bool buttonsBefore = cbp.buttonsBefore != ::Qt::NoButton;
        QString keyModifierString = keyString2(cbp.modifiers + cbp.key);
        ...
        return tr("%1%2%3%4%5%6", "Modifier / button or wheel / double click / with "
            ...
            .arg(mouseButtonsString2(cbp.button) +
            ...
            .arg(buttonsBefore ? tr(" with ", "As in : Left button with Ctrl pressed")
                : "")
            .arg(buttonsBefore ? mouseButtonsString2(cbp.buttonsBefore) : "")
            .arg(buttonsBefore
    ...
    CGAL_INLINE_FUNCTION
        bool CGAL::QVulkanViewer::isValidShortcutKey(int key) {
     ...
     */
    CGAL_INLINE_FUNCTION
        void CGAL::QVulkanViewer::setMouseBindingDescription(::Qt::KeyboardModifiers modifiers,
    ...
    bindings. */
    CGAL_INLINE_FUNCTION
        void CGAL::QVulkanViewer::setMouseBindingDescription(
    ...
    static QString tableLine2(const QString& left, const QString& right) {
    ...
    CGAL_INLINE_FUNCTION
        QString CGAL::QVulkanViewer::mouseString() const {
        QString text(
        ...
        for (QMap<ClickBindingPrivate, QString>::ConstIterator
            ...
            text += tableLine2(formatClickActionPrivate(it.key()), it.value());
        }
        ...
        for (QMap<ClickBindingPrivate, QString>::ConstIterator
            ...
            text += tableLine2(formatClickActionPrivate(it2.key()), it2.value());
        }
    ...
    details. */
    CGAL_INLINE_FUNCTION
        void CGAL::QVulkanViewer::setKeyDescription(unsigned int key, QString description) {
        if (description.isEmpty())
    ...
    CGAL_INLINE_FUNCTION
        QString CGAL::QVulkanViewer::cameraPathKeysString() const {
    ...
    setKeyDescription() as well as the \e standard CGAL::QVulkanViewer::KeyboardAction
    ...
    CGAL_INLINE_FUNCTION
        QString CGAL::QVulkanViewer::keyboardString() const {
        QString text(
            "<center><table border=\"1\" cellspacing=\"0\" cellpadding=\"4\">\n");
        text += QString("<tr bgcolor=\"#aaaacc\"><th align=\"center\">%1</th><th "
            "align=\"center\">%2</th></tr>\n")
            .arg(CGAL::QVulkanViewer::tr("Key(s)",
                "Keys column header in help window mouse tab"))
            .arg(CGAL::QVulkanViewer::tr(
                "Description",
                "Description column header in help window mouse tab"));
        ...
        for (QMap<unsigned int, QString>::ConstIterator kb = keyDescription.begin(),
            ...
            kb != endb; ++kb)
            text += tableLine2(keyString2(kb.key()), kb.value());

        // 2 - Optional separator line
        if (!keyDescription.isEmpty()) {
            keyDescription.clear();
            text += QString("<tr bgcolor=\"#aaaacc\"><td colspan=2>%1</td></tr>\n")
                .arg(CGAL::QVulkanViewer::tr("Standard viewer keys",
        ...
        for (QMap<unsigned int, QString>::ConstIterator kb2 = keyDescription.begin(),
            ...
            kb2 != endb2; ++kb2)
            text += tableLine2(keyString2(kb2.key()), kb2.value());

        // 4 - Camera paths keys description
        const QString cpks = cameraPathKeysString();
        if (!cpks.isNull()) {
            text += "<tr bgcolor=\"#ccccff\"><td colspan=2>\n";
            text += CGAL::QVulkanViewer::tr("Camera paths are controlled using the %1 keys "
                "(noted <i>Fx</i> below):",
                "Help window key tab camera keys")
                .arg(cpks) +
                "</td></tr>\n";
            text += tableLine2(
                keyString2(playPathKeyboardModifiers()) + "<i>" +
                CGAL::QVulkanViewer::tr("Fx", "Generic function key (F1..F12)") + "</i>",
                CGAL::QVulkanViewer::tr("Plays path (or resets saved position)"));
            text += tableLine2(
                keyString2(addKeyFrameKeyboardModifiers()) + "<i>" +
                CGAL::QVulkanViewer::tr("Fx", "Generic function key (F1..F12)") + "</i>",
                CGAL::QVulkanViewer::tr("Adds a key frame to path (or defines a position)"));
            text += tableLine2(
                keyString2(addKeyFrameKeyboardModifiers()) + "<i>" +
                CGAL::QVulkanViewer::tr("Fx", "Generic function key (F1..F12)") + "</i>+<i>" +
                CGAL::QVulkanViewer::tr("Fx", "Generic function key (F1..F12)") + "</i>",
                CGAL::QVulkanViewer::tr("Deletes path (or saved position)"));
        }
        text += "</table></center>";
    ...
    CGAL_INLINE_FUNCTION
        void CGAL::QVulkanViewer::aboutQVulkanViewer() {
        help();
        helpWidget()->setCurrentIndex(3);
    }

    /*! Opens a modal help window that includes four tabs, respectively filled with
    helpString(), keyboardString(), mouseString() and about libCGAL::QVulkanViewer.

    Rich html-like text can be used (see the QStyleSheet documentation). This method
    is called when the user presses the CGAL::QVulkanViewer::HELP key (default is 'H').
...
#include "resources/qglviewer-icon.xpm"
    ...
    Viewer::keyPressEvent(QKeyEvent *e)
    {
      ...
      CGAL::QVulkanViewer::keyPressEvent(e);
    }
    ...
    CGAL_INLINE_FUNCTION
        void CGAL::QVulkanViewer::keyPressEvent(QKeyEvent* e) {
        if (e->key() == 0) {
            e->ignore();
            return;
        }
    ...
    CGAL_INLINE_FUNCTION
        void CGAL::QVulkanViewer::keyReleaseEvent(QKeyEvent* e) {
        if (isValidShortcutKey(e->key()))
            currentlyPressedKey_ = ::Qt::Key(0);
    }

    CGAL_INLINE_FUNCTION
        void CGAL::QVulkanViewer::handleKeyboardAction(qglviewer::KeyboardAction id) {
        switch (id) {
    ...
    CGAL_INLINE_FUNCTION
        void CGAL::QVulkanViewer::resizeGL(int width, int height) {
    ...
    /*! Defines the shortcut() that triggers a given CGAL::QVulkanViewer::KeyboardAction.
    ...
    Only one shortcut can be assigned to a given CGAL::QVulkanViewer::KeyboardAction (new
    bindings replace previous ones). If several KeyboardAction are binded to the
    same shortcut, only one of them is active. */
    CGAL_INLINE_FUNCTION
        void CGAL::QVulkanViewer::setShortcut(qglviewer::KeyboardAction action, unsigned int key) {
        keyboardBinding_[action] = key;
    }

    /*! Returns the keyboard shortcut associated to a given
    CGAL::QVulkanViewer::KeyboardAction.
    ...
    CGAL_INLINE_FUNCTION
        unsigned int CGAL::QVulkanViewer::shortcut(qglviewer::KeyboardAction action) const {
    ...
    CGAL_INLINE_FUNCTION
        ::Qt::Key CGAL::QVulkanViewer::pathKey(unsigned int index) const {
    ...
    \endcode */
    CGAL_INLINE_FUNCTION
        void CGAL::QVulkanViewer::setPathKey(int key, unsigned int index) {
    ...
    CGAL_INLINE_FUNCTION
        void CGAL::QVulkanViewer::setPlayPathKeyboardModifiers(::Qt::KeyboardModifiers modifiers) {
        playPathKeyboardModifiers_ = modifiers;
    }

    /*! Sets the addKeyFrameKeyboardModifiers() value. */
    CGAL_INLINE_FUNCTION
        void CGAL::QVulkanViewer::setAddKeyFrameKeyboardModifiers(
            ::Qt::KeyboardModifiers modifiers) {
    ...
    CGAL_INLINE_FUNCTION
        ::Qt::KeyboardModifiers CGAL::QVulkanViewer::addKeyFrameKeyboardModifiers() const {
    ...
    CGAL_INLINE_FUNCTION
        ::Qt::KeyboardModifiers CGAL::QVulkanViewer::playPathKeyboardModifiers() const {
    ...
    /*! Defines a MouseAction binding.
      ...
      action). */
    CGAL_INLINE_FUNCTION
        void CGAL::QVulkanViewer::setMouseBinding(::Qt::KeyboardModifiers modifiers,
    ...
    (CGAL::QVulkanViewer::CAMERA or CGAL::QVulkanViewer::FRAME).
    ...
    CGAL_INLINE_FUNCTION
        void CGAL::QVulkanViewer::setMouseBinding(::Qt::Key key, ::Qt::KeyboardModifiers modifiers,
            ::Qt::MouseButton button, qglviewer::MouseHandler handler,
            qglviewer::MouseAction action, bool withConstraint) {
    ...
    */
    ...
    CGAL_INLINE_FUNCTION
        void CGAL::QVulkanViewer::setWheelBinding(::Qt::KeyboardModifiers modifiers,
    ...
    In the current implementation only CGAL::QVulkanViewer::ZOOM can be associated with
    CGAL::QVulkanViewer::FRAME, while CGAL::QVulkanViewer::CAMERA can receive CGAL::QVulkanViewer::ZOOM and
    CGAL::QVulkanViewer::MOVE_FORWARD.

    The difference between CGAL::QVulkanViewer::ZOOM and CGAL::QVulkanViewer::MOVE_FORWARD is that
    CGAL::QVulkanViewer::ZOOM speed depends on the distance to the object, while
    CGAL::QVulkanViewer::MOVE_FORWARD moves at a constant speed defined by
    CGAL::qglviewer::Camera::flySpeed(). */
    CGAL_INLINE_FUNCTION
        void CGAL::QVulkanViewer::setWheelBinding(::Qt::Key key, ::Qt::KeyboardModifiers modifiers,
            qglviewer::MouseHandler handler, qglviewer::MouseAction action,
            bool withConstraint) {
    ...
    */
    CGAL_INLINE_FUNCTION
        void CGAL::QVulkanViewer::clearMouseBindings() {
        mouseBinding_.clear();
        clickBinding_.clear();
        wheelBinding_.clear();
    }
    ...
    */
    CGAL_INLINE_FUNCTION
        void CGAL::QVulkanViewer::clearShortcuts() {
    ...
    Returns CGAL::QVulkanViewer::NO_MOUSE_ACTION if no action is associated with this
    ...
    if (ma != CGAL::QVulkanViewer::NO_MOUSE_ACTION) ...
    \endcode

    Use mouseHandler() to know which object (CGAL::QVulkanViewer::CAMERA or CGAL::QVulkanViewer::FRAME)
    will execute this action. */
    CGAL_INLINE_FUNCTION
        qglviewer::MouseAction CGAL::QVulkanViewer::mouseAction(::Qt::Key key,
            ::Qt::KeyboardModifiers modifiers,
    ...
    if (mh == CGAL::QVulkanViewer::CAMERA) ...
    \endcode

    Use mouseAction() to know which action (see the MouseAction enum) will be
    performed on this handler. */
    CGAL_INLINE_FUNCTION
        int CGAL::QVulkanViewer::mouseHandler(::Qt::Key key, ::Qt::KeyboardModifiers modifiers,
            ::Qt::MouseButton button) const {
        MouseBindingPrivate mbp(modifiers, button, key);
        if (mouseBinding_.contains(mbp))
    ...
    */
    CGAL_INLINE_FUNCTION
        void CGAL::QVulkanViewer::getWheelActionBinding(qglviewer::MouseHandler handler, qglviewer::MouseAction action,
    ...
    */
    CGAL_INLINE_FUNCTION
        void CGAL::QVulkanViewer::getMouseActionBinding(qglviewer::MouseHandler handler, qglviewer::MouseAction action,
            bool withConstraint, ::Qt::Key& key,
            ::Qt::KeyboardModifiers& modifiers,
            ::Qt::MouseButton& button) const {
        for (QMap<MouseBindingPrivate, MouseActionPrivate>::ConstIterator
    ...
    */
    qglviewer::MouseAction
        CGAL_INLINE_FUNCTION
        CGAL::QVulkanViewer::wheelAction(::Qt::Key key, ::Qt::KeyboardModifiers modifiers) const {
        WheelBindingPrivate wbp(modifiers, key);
        if (wheelBinding_.contains(wbp))
    ...
    */
    CGAL_INLINE_FUNCTION
        int CGAL::QVulkanViewer::wheelHandler(::Qt::Key key,
            ::Qt::KeyboardModifiers modifiers) const {
        WheelBindingPrivate wbp(modifiers, key);
        if (wheelBinding_.contains(wbp))
    ...
    CGAL_INLINE_FUNCTION
        ...
        CGAL::QVulkanViewer::clickAction(::Qt::Key key, ::Qt::KeyboardModifiers modifiers,
    ...
    */
    CGAL_INLINE_FUNCTION
        void CGAL::QVulkanViewer::getClickActionBinding(qglviewer::ClickAction action, ::Qt::Key& key,
            ::Qt::KeyboardModifiers& modifiers,
            ::Qt::MouseButton& button,
            bool& doubleClick,
            ::Qt::MouseButtons& buttonsBefore) const {
    ...
    CGAL_INLINE_FUNCTION
        bool CGAL::QVulkanViewer::cameraIsInRotateMode() const {
    ...
    \arg In rotate mode: CGAL::QVulkanViewer::ROTATE, CGAL::QVulkanViewer::ZOOM, CGAL::QVulkanViewer::TRANSLATE.
    \arg In fly mode: CGAL::QVulkanViewer::MOVE_FORWARD, CGAL::QVulkanViewer::LOOK_AROUND,
    CGAL::QVulkanViewer::MOVE_BACKWARD.

    The current mode is determined by checking if a mouse button is binded to
    CGAL::QVulkanViewer::ROTATE for the CGAL::QVulkanViewer::CAMERA. The state key that was previously
    used to move the camera is preserved. */
    CGAL_INLINE_FUNCTION
        void CGAL::QVulkanViewer::toggleCameraMode() {
        ::Qt::Key key;
        ::Qt::KeyboardModifiers modifiers;
        ::Qt::MouseButton button;
        getMouseActionBinding(qglviewer::CAMERA, qglviewer::ROTATE, true /*constraint*/, key, modifiers,
    ...
    a second viewer. */
    CGAL_INLINE_FUNCTION
        void CGAL::QVulkanViewer::setManipulatedFrame(qglviewer::ManipulatedFrame* frame) {
        if (manipulatedFrame()) {
    ...
    CGAL_INLINE_FUNCTION
        void CGAL::QVulkanViewer::drawVisualHints() {
    ...
    CGAL_INLINE_FUNCTION
        void CGAL::QVulkanViewer::setVisualHintsMask(int mask, int delay) {
    ...
    CGAL_INLINE_FUNCTION
        void CGAL::QVulkanViewer::resetVisualHints() { visualHint_ = 0; }
#endif
    ...
    */
    CGAL_INLINE_FUNCTION
        void CGAL::QVulkanViewer::drawArrow(double r, double R, int prec,
    ...
    CGAL_INLINE_FUNCTION
        void CGAL::QVulkanViewer::drawAxis(qreal length) {
    ...
    CGAL_INLINE_FUNCTION
        void CGAL::QVulkanViewer::drawGrid(qreal size, int nbSubdivisions) {
    ...
    CGAL_INLINE_FUNCTION
        void CGAL::QVulkanViewer::copyBufferToTexture(GLint, GLenum) {
    }
    ...
    CGAL_INLINE_FUNCTION
        GLuint CGAL::QVulkanViewer::bufferTextureId() const {
        return 0;
    }

    CGAL_INLINE_FUNCTION
        void CGAL::QVulkanViewer::setOffset(CGAL::qglviewer::Vec offset)
    {
        this->_offset = offset;
    }

    CGAL_INLINE_FUNCTION
        const CGAL::qglviewer::Vec& CGAL::QVulkanViewer::offset() const
    {
        return _offset;
    }

    CGAL_INLINE_FUNCTION
        qreal CGAL::QVulkanViewer::sceneRadius() const { return camera()->sceneRadius(); }

    CGAL_INLINE_FUNCTION
        CGAL::qglviewer::Vec CGAL::QVulkanViewer::sceneCenter() const { return camera()->sceneCenter(); }

    CGAL_INLINE_FUNCTION
        void CGAL::QVulkanViewer::setSceneRadius(qreal radius) {
        camera()->setSceneRadius(radius);
    }

    CGAL_INLINE_FUNCTION
        void CGAL::QVulkanViewer::setSceneCenter(const CGAL::qglviewer::Vec& center) {
        camera()->setSceneCenter(center);
    }

    CGAL_INLINE_FUNCTION
        void CGAL::QVulkanViewer::setSceneBoundingBox(const CGAL::qglviewer::Vec& min,
            const CGAL::qglviewer::Vec& max) {
        camera()->setSceneBoundingBox(min + offset(), max + offset());
    }

    CGAL_INLINE_FUNCTION
        void CGAL::QVulkanViewer::showEntireScene() {
        camera()->showEntireScene();
        update();
    }
    ...
    CGAL_INLINE_FUNCTION
        QImage* CGAL::QVulkanViewer::takeSnapshot(CGAL::qglviewer::SnapShotBackground background_color,
            QSize finalSize,
            double oversampling,
            bool expand)
    {
    ...
    CGAL_INLINE_FUNCTION
        QOpenGLFramebufferObject* CGAL::QVulkanViewer::getStoredFrameBuffer() const
    {
        return stored_fbo;
    }

    CGAL_INLINE_FUNCTION
        void CGAL::QVulkanViewer::setStoredFrameBuffer(QOpenGLFramebufferObject* fbo)
    {
        stored_fbo = fbo;
    }

    CGAL_INLINE_FUNCTION
        void CGAL::QVulkanViewer::saveSnapshot()
    {
        qreal aspectRatio = width() / static_cast<qreal>(height());
    ...
    CGAL_INLINE_FUNCTION
        void CGAL::QVulkanViewer::saveSnapshot(const QString& fileName,
...
CGAL_INLINE_FUNCTION
bool CGAL::QVulkanViewer::isSharing() const
{
    return is_sharing;
}
