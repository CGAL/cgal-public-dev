...
#ifndef CGAL_BASIC_VIEWER_QT_VULKAN_H
#define CGAL_BASIC_VIEWER_QT_VULKAN_H
...
namespace CGAL
{
    ...
    //------------------------------------------------------------------------------
    class Basic_viewer_qt : public CGAL::QVulkanViewer
    {
    public:
                ...
                &arrays[SMOOTH_NORMAL_COLORED_FACES])
        {
            ...
            //initialize_buffers();
            //m_renderer->setSources(m_buffer_for_mono_points);
        }
        ...
        bool is_empty() const
        {
            return (m_buffer_for_mono_points.empty() &&
        ...
        void add_point(const KPoint& p)
        {
            ...
            m_buffer_for_mono_points.push_back(lp.x());
            m_buffer_for_mono_points.push_back(lp.y());
            m_buffer_for_mono_points.push_back(lp.z());
            ...
            const CGAL::IO::Color& acolor)
        {
            ...
            Local_point lp1 = get_local_point(p1);
            Local_point lp2 = get_local_point(p2);
            m_buffer_for_edges.push_back(lp1.x());
            m_buffer_for_edges.push_back(lp1.y());
            m_buffer_for_edges.push_back(lp1.z());
            m_buffer_for_edges.push_back(lp2.x());
            m_buffer_for_edges.push_back(lp2.y());
            m_buffer_for_edges.push_back(lp2.z());
        }
        ...
        {
            Local_point lp = get_local_point(kp);
            m_buffer_for_faces.push_back(lp.x());
            m_buffer_for_faces.push_back(lp.y());
            m_buffer_for_faces.push_back(lp.z());
    ...
    protected:
        ...
        void attrib_buffers(CGAL::QVulkanViewer* viewer)
        {
