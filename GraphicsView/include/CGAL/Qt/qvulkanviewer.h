...
#ifndef QVULKANVIEWER_QVULKANVIEWER_H
#define QVULKANVIEWER_QVULKANVIEWER_H
...
namespace CGAL {
    ...
    public:
        ...
        explicit QVulkanViewer(QOpenGLContext* instance, QWidget* parent = nullptr,::Qt::WindowFlags flags = ::Qt::WindowType(0));
        explicit QVulkanViewer(QWidget* parent = nullptr,
            ::Qt::WindowFlags flags = ::Qt::WindowType(0));
        //explicit QVulkanViewer(QWidget* parent = nullptr, ::Qt::WindowFlags flags = ::Qt::WindowType(0), VulkanWindow* w = nullptr);

        virtual ~QVulkanViewer();
  ...
  //@{
    ...
    public Q_SLOTS:
        virtual void help();
        virtual void aboutQVulkanViewer();
    ...
    public:
        ...
        \endcode
      */
        static QList<QVulkanViewer*>& QVulkanViewerPool();
        ...
        static int QVulkanViewerIndex(const QVulkanViewer* const viewer) {
            return QVulkanViewer::QVulkanViewerPool().indexOf(const_cast<QVulkanViewer*>(viewer));
        }
        //@}
  ...
  //@{
    ...
    private:
        ...
        QVulkanViewer(const QVulkanViewer& v);
        QVulkanViewer& operator=(const QVulkanViewer& v);
    ...
    protected:
        ...
        // TODO: need to change these for Vulkan
        enum VBO
        {
            Grid = 0,
