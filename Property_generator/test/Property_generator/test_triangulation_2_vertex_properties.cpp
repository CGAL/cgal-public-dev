...
void run_tests_epic() {
  ...
  Dual_area<Delaunay, CGAL::No_finite_test_tag> dual_area_0_a(dt_0),
      dual_area_1_a(dt_1), dual_area_5_a(dt_5);
  Dual_area<Delaunay, CGAL::Finite_test_tag> dual_area_0_b(dt_0),
      dual_area_1_b(dt_1), dual_area_5_b(dt_5);
  Dual_area<Delaunay> dual_area_0_c(dt_0), dual_area_1_c(dt_1),
      dual_area_5_c(dt_5);

  // The Voronoi cell is unbounded in each of these cases.
  assert(exact_eq<double>(dual_area_0_b(v_0), infinity));
  assert(exact_eq<double>(dual_area_1_b(v_1), infinity));
  assert(exact_eq<double>(dual_area_0_c(v_0), infinity));
  ...
  Star_area<Delaunay, CGAL::No_finite_test_tag> star_area_0_a(dt_0),
      star_area_1_a(dt_1), star_area_5_a(dt_5);
  Star_area<Delaunay, CGAL::Finite_test_tag> star_area_0_b(dt_0),
      star_area_1_b(dt_1), star_area_5_b(dt_5);
  Star_area<Delaunay> star_area_0_c(dt_0), star_area_1_c(dt_1),
      star_area_5_c(dt_5);

  // Unbounded tests.
  assert(exact_eq(star_area_0_b(v_0), infinity));
  assert(exact_eq(star_area_1_c(v_1), infinity));
  ...
  Link_length<Delaunay, CGAL::No_finite_test_tag> link_length_0_a(dt_0),
      link_length_1_a(dt_1), link_length_5_a(dt_5);
  Link_length<Delaunay, CGAL::Finite_test_tag> link_length_0_b(dt_0),
      link_length_1_b(dt_1), link_length_5_b(dt_5);
  ...
  Max_star_angle<Delaunay, CGAL::No_finite_test_tag> max_star_angle_0_a(dt_0),
      max_star_angle_1_a(dt_1), max_star_angle_5_a(dt_5);
  Max_star_angle<Delaunay, CGAL::Finite_test_tag> max_star_angle_0_b(dt_0),
      max_star_angle_1_b(dt_1), max_star_angle_5_b(dt_5);
  Max_star_angle<Delaunay> max_star_angle_0_c(dt_0), max_star_angle_1_c(dt_1),
...
void run_tests_epec() {
  ...
  Dual_area<Delaunay, CGAL::No_finite_test_tag> dual_area_5_a(dt_5);

  // Compare dual area with manually computed value.
  assert(approx_eq(CGAL::to_double(dual_area_5_a(v_5[0])), 2.64583));
