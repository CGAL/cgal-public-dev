...
public:
    ...
    //!  type of Bound
    typedef typename Z_at_xy_isolator::Bound Bound;
...
public:
    ...
    //! type of z-cell
    typedef CGAL::internal::Z_cell< Surface_z_at_xy_isolator_traits, Dcel_data > 
        Z_cell;
...
CGAL::internal::Z_stack_rep< SurfaceZAtXyIsolatorTraits, DcelData > > {
public:
    //! this instance's first template parameter
    typedef SurfaceZAtXyIsolatorTraits Surface_z_at_xy_isolator_traits;
    ...
    //! type of rep
    typedef 
    CGAL::internal::Z_stack_rep< Surface_z_at_xy_isolator_traits, Dcel_data > 
    Rep; 
...
private:
    ...
    void _update_cells(const Surface_3& surface2, 
        ...
        // else
        // for each 0 <= i < roots2: 
        // find position of (isol2.left_bound(i), isol2.right_bound(i)) 
        ...
        CGAL::internal::Refineable_interval_helper< Z_at_xy_isolator > iv_helper;
...
public:
    ...
    // for _isolator
    friend class 
    CGAL::internal::Z_cell< Surface_z_at_xy_isolator_traits, Dcel_data >;
