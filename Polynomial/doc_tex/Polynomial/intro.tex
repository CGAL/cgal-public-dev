...
\begin{itemize}
\item \ccc{Default_parser_policy}: parses polynomials "as is". In other words, coefficients of the type
...
The class \ccc{CGAL::Polynomial_parser_d< Poly_d_, ParserPolicy >} has been developed
