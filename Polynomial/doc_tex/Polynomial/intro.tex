...
\begin{itemize}
\item \ccc{Default_parser_policy}: no type conversions are performed. In other words, coefficients of the type
\ccc{Innermost_coefficient_type} of the target polynomial are read directly from the input stream;
...
The class \ccc{CGAL::Polynomial_parser_d< Polynomial_d_, ParserPolicy >} has been developed
