...
and converts it to the output type \ccc{Coeff}, \ccc{is} points to the first 
...
\ccNestedType{Polynomial_d}{See \ccc{ParserPolicy} concept.}\ccGlue
\ccNestedType{Coeff}{Innermost coefficient type of \ccc{Polynomial_d}.}\ccGlue
\ccNestedType{Integer}{Integer coefficient type which is \ccc{ExplicitInteroperable} with \ccc{Coeff} number type.}\ccGlue
\ccNestedType{Rational}{Rational coefficient type which is \ccc{ExplicitInteroperable} with \ccc{Coeff} number type.}\ccGlue
...
\ccNestedType{Integer}{Integer coefficient type which is \ccc{ExplicitInteroperable} with \ccc{Coeff} number type.}\ccGlue
\ccNestedType{Rational}{Rational coefficient type which is \ccc{ExplicitInteroperable} with \ccc{Coeff} number type.}\ccGlue
\ccNestedType{BigFloat}{BigFloat coefficient type which is \ccc{ExplicitInteroperable}  with \ccc{Coeff} number type.}\ccGlue
