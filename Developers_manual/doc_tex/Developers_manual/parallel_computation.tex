...
The number of threads created can be controlled by setting \ccc{OMP_NUM_THREADS} environment variable. By default the number of threads created will be equal to the number of hardware threads available on the system.

\section{Disabling Parallel Computation\label{sec:disable_parallel}}

To disable OpenMP for the \ccc{Boolean_set_operations_2} package the user must define the compilation flag \ccc{CGAL_BOOLEAN_SET_OPERATIONS_2_SERIAL}
