...
#ifndef CGAL_ARR_MOEBIUS_STRIP_TOPOLOGY_TRAITS_2_IMPL_H
#define CGAL_ARR_MOEBIUS_STRIP_TOPOLOGY_TRAITS_2_IMPL_H

/*! \file
 * Member-function definitions for the
 * Arr_moebius_strip_topology_traits_2<GeomTraits> class.
 */
...
Arr_moebius_strip_topology_traits_2<GeomTraits, Dcel_>::
Arr_moebius_strip_topology_traits_2() :
    _m_own_traits (true), 
    _m_f_top(NULL)
{
    // status: implememnt
    ...
    _m_hline0 = Hline(Point_2_less_NS(_m_traits));
    _m_hline1 = Hline(Point_2_less_NS(_m_traits));
}
...
template <class GeomTraits, class Dcel_>
Arr_moebius_strip_topology_traits_2<GeomTraits, Dcel_>::
Arr_moebius_strip_topology_traits_2 (Geometry_traits_2 *tr) : 
    _m_own_traits(false),  
    _m_f_top(NULL)
{
    // status: implement
...
//
template <class GeomTraits, class Dcel_>
void Arr_moebius_strip_topology_traits_2<GeomTraits, Dcel_>::assign
    (const Self& other)
{
    // status: implement/missing dcel-assign
    std::cout << "Arr_moebius_strip_topology_traits_2 assign"  << std::endl;
    // Assign the class.
...
//
template <class GeomTraits, class Dcel_>
void Arr_moebius_strip_topology_traits_2<GeomTraits, Dcel_>::init_dcel ()
{
    // status: check fictitious halfedges
    std::cout << "Arr_moebius_strip_topology_traits_2 init_dcel"  
              << std::endl;
    ...
    this->_m_hline0.clear();
    this->_m_hline1.clear();

    this->_m_vertices_on_hline0.clear();
    this->_m_vertices_on_hline1.clear();
...
template <class GeomTraits, class Dcel_>
Comparison_result
Arr_moebius_strip_topology_traits_2<GeomTraits, Dcel_>::compare_y_at_x
(const Point_2& p, const Halfedge* he) const
{
    // status: correct
    //std::cout << "Arr_moebius_strip_topology_traits_2 compare_y_at_x"
    //          << std::endl;
...
//
template <class GeomTraits, class Dcel_>
bool Arr_moebius_strip_topology_traits_2<GeomTraits, Dcel_>::are_equal
(const Vertex *v,
 const X_monotone_curve_2& cv, Curve_end ind,
 CGAL::Boundary_type bound_x, CGAL::Boundary_type bound_y) const
{
    // status: correct
    std::cout << "Arr_moebius_strip_topology_traits_2 are_equal"  
              << std::endl;
...
template <class GeomTraits, class Dcel_>
CGAL::Object
Arr_moebius_strip_topology_traits_2<GeomTraits, Dcel_>::place_boundary_vertex
    (Face *f,
     const X_monotone_curve_2& cv, CGAL::Curve_end ind,
     Boundary_type bound_x, Boundary_type bound_y)
{
    // status: correct
    std::cout << "Arr_moebius_strip_topology_traits_2 place_boundary_vertex"  
              << std::endl;
...
//
template <class GeomTraits, class Dcel_>
typename Arr_moebius_strip_topology_traits_2<GeomTraits,Dcel_>::Halfedge* 
Arr_moebius_strip_topology_traits_2<GeomTraits,Dcel_>::locate_around_boundary_vertex
    (Vertex *v,
     const X_monotone_curve_2& cv, Curve_end ind,
     Boundary_type bound_x, Boundary_type bound_y) const
{
    ...
    std::cout << "Arr_moebius_strip_topology_traits_2 locate_around_boundary_vertex"  
              << std::endl;
...
{
    // status: correct
    std::cout << "Arr_moebius_strip_topology_traits_2::" 
              << "notify_on_boundary_vertex_creation"
              << std::endl;       
...
template <class GeomTraits, class Dcel_>
bool
Arr_moebius_strip_topology_traits_2<GeomTraits,Dcel_>::_is_perimetric_path
(const Halfedge *e1,
 const Halfedge *e2,
 bool& touching_pole) const
{
    // status: correct
    std::cout << "Arr_moebius_strip_topology_traits_2::is_perimetric_path" 
              << std::endl;
...
template <class GeomTraits, class Dcel_>
std::pair<bool, bool>
Arr_moebius_strip_topology_traits_2<GeomTraits,Dcel_>::face_split_after_edge_insertion
    (const Halfedge *prev1,
     const Halfedge *prev2,
     const X_monotone_curve_2& cv) const
{
    // status: correct
    std::cout << "Arr_moebius_strip_topology_traits_2 face_split"  << std::endl;
    ...
    // on a moebius_strip except for one case, there is a face split
    if (perimetric) {
        if (tpole1 || tpole2) {
...
template <class GeomTraits, class Dcel_>
bool
Arr_moebius_strip_topology_traits_2<GeomTraits,Dcel_>::hole_creation_after_edge_removal
(const Halfedge *he) const
{
    // status: check implementation
    std::cout << "Arr_moebius_strip_topology_traits_2 hole_creation"  << std::endl;

    CGAL_assertion(false); // hole_creation not finally implemented for moebius_strip

    CGAL_precondition (! he->is_on_inner_ccb());
    CGAL_precondition (! he->opposite()->is_on_inner_ccb());

    // TODO hole_creation for moebius_strip
    ...
    if (he->outer_ccb() == he->opposite()->outer_ccb()) {
        ...
        if (_is_perimetric_path (he, he, tpole1) &&
            ...
            // else
            // In this case we disconnect a perimetric cycle around the moebius_strip,
 ...
 const X_monotone_curve_2& cv) const
{
    ...
    if (prev1->inner_ccb()->face() != top_face()) {
        ...
        // the pole of the moebius_strip is split into two perimetric faces
...
template <class GeomTraits, class Dcel_>
bool
Arr_moebius_strip_topology_traits_2<GeomTraits,Dcel_>::boundaries_of_same_face
(const Halfedge *e1,
 const Halfedge *e2) const
{
    // status: check correctness of implementation
    std::cout << " Arr_moebius_strip_topology_traits_2::boundaries_of_same_face" 
              << std::endl;
...
//
template <class GeomTraits, class Dcel_>
bool Arr_moebius_strip_topology_traits_2<GeomTraits, Dcel_>::is_in_face
(const Face *f, const Point_2& p, const Vertex *v) const
{
    // status: not implemented
    // TODO is_in_face NEEDED for incremental insertion
    std::cout << "TODO: Arr_moebius_strip_topology_traits_2::is_in_face" 
              << std::endl;

    CGAL_assertion(false); // is_in_face not implemented for moebius_strip
#if 0
...
//-----------------------------------------------------------------------------
// Split fictitious halfedge
//
template <class GeomTraits, class Dcel_>
Halfegde* Arr_moebius_strip_topology_traits_2<GeomTraits, Dcel_>::
split_fictitious_edge (Halfedge *e, Vertex *v) const {
    //std::cout << "Arr_moebius_strip_topology_traits_2::"
    //          << "split_fictious_edge" 
    //          << std::endl;
    // TODO implement
...
//
template <class GeomTraits, class Dcel_>
bool Arr_moebius_strip_topology_traits_2<GeomTraits, Dcel_>::is_redundant
(const Vertex *v) const
{
    // status: correct
    
    std::cout << "Arr_moebius_strip_topology_traits_2 is_redundant"  << std::endl;
...
template <class GeomTraits, class Dcel_>
typename Arr_moebius_strip_topology_traits_2<GeomTraits, Dcel_>::Halfedge* 
Arr_moebius_strip_topology_traits_2<GeomTraits, Dcel_>::erase_redundant_vertex
(Vertex *v) 
{
    // status: correct
    
    std::cout << "Arr_moebius_strip_topology_traits_2 erase_redundant_vertex"  
              << std::endl;
    CGAL_precondition(_valid(v->boundary_in_x(),v->boundary_in_y()));
...
_crossings_with_identifications(
    ...
    std::cout << "Arr_moebius_strip_topology_traits: "
