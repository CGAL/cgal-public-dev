...
#ifndef CGAL_ARR_MOEBIUS_STRIP_TOPOLOGY_TRAITS_2_H
#define CGAL_ARR_MOEBIUS_STRIP_TOPOLOGY_TRAITS_2_H

/*! \file
 * Definition of the Arr_moebius_strip_topology_traits_2<GeomTraits> class.
 */
...
// TODO moeb helpers
#include <CGAL/Arr_topology_traits/Arr_moebius_strip_construction_helper.h>
...
/*! \class Arr_moebius_strip_topology_traits_2
...
public:
    ...
    typedef Arr_moebius_strip_topology_traits_2<Geometry_traits_2, Dcel> Self;
    ...
    struct rebind
    {
        typedef Arr_moebius_strip_topology_traits_2<T,D> other;
    };
...
protected:
    ...
    //! type of line of identification
    ...
    //! type of line of "lower/upper boundary"
    typedef std::map< Point_2, Vertex*, Point_2_less_NS >  Hline;
    ...
    //! used to locate curve-ends on the "lower boundary"
    mutable Hline _m_hline0;
    
    //! used to locate curve-ends on the "upper boundary"
    mutable Hline _m_hline1;
    
    //! used to locate vertices on hline0
    mutabale Vertices_on_hline _m_vertices_on_hline;0

    //! used to locate vertices on hline1
    mutabale Vertices_on_hline _m_vertices_on_hline1;
    
    //! Copy constructor - not supported.
    Arr_moebius_strip_topology_traits_2 (const Self& );
...
public:
    ...
    {
        //std::cout << "Arr_moebius_strip_topological_traits_2::"
        //          << "is_concrete_vertex"
        //          << std::endl;
    ...
    Size number_of_concrete_vertices () const
    {
        ...
        //          << std::endl;
        // TODO check corners of parameter space
    ...
    Size number_of_valid_halfedges () const
    {
        ...
        //          << std::endl;
        // TODO number of valid halfedges
    ...
    {
        //std::cout << "Arr_moebius_strip_topological_traits_2::is_valid_face"
        //          << std::endl;
        // all faces are valid
        return (true);
    }
...
private:
    ...
    typedef Arr_construction_event<Geometry_traits_2,
                                 CSubcurve,
                                 Arr>                            CEvent;
    typedef Arr_moebius_strip_construction_helper<Geometry_traits_2,
                                             Arr,
                                             CEvent,
                                             CSubcurve>          CHelper;
...
public:
    ...
    CGAL::Object locate_unbounded_curve_end (const X_monotone_curve_2& cv,
                                             ...
                                             Boundary_type bound_x,
                                             Boundary_type bound_y) {
        // moebius strip does not contain unbounded curves
...
public:
     ...
     *         the split vertex v.
     */
    Halfedge* split_fictitious_edge (Halfedge *e, Vertex *v) const;
...
protected:
    ...
    bool  _valid(CGAL::Boundary_type bound_x, CGAL::Boundary_type bound_y) 
        ...
        return (                        
                ...
                ||
                // TASK introduce FINITE boundary for y
...
public:
    ...
    /*! Get the vertex on line of identification associated with \c pt*/
    Vertex* vertex_on_hline(const Point_2& key, int line) {
        CGAL_precondition(line >= 0 && line <= 1);
        const Hline& hline = (line == 0 ? this->m_hline0 : this->m_hline1);
        typename Hline::iterator it = hline.find(key);
        if (it != hline.end()) {
            return it->second;
        }
        // else
