...
function(CGAL_add_all_subdirs type)
  foreach(package ${CGAL_CONFIGURED_PACKAGES})
    file(GLOB children RELATIVE ${CMAKE_SOURCE_DIR} ${package}/${type}/*)
    foreach(child ${children})
      if(IS_DIRECTORY ${CMAKE_SOURCE_DIR}/${child} AND EXISTS ${CMAKE_SOURCE_DIR}/${child}/CMakeLists.txt)
        get_filename_component(child_clean ${child} NAME_WE)
        add_subdirectory(${CMAKE_SOURCE_DIR}/${child} ${CMAKE_BINARY_DIR}/examples/${child_clean})
      endif()
    endforeach()
  endforeach()
endfunction()