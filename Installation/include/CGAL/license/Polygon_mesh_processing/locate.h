...
#  if defined(CGAL_LICENSE_WARNING)
     CGAL_pragma_warning("You use the CGAL Polygon Mesh Processing - Locate package under "
                         "the terms of the GPLv3+.")
#  endif // CGAL_LICENSE_WARNING

#  ifdef CGAL_LICENSE_ERROR
#    error "You use the CGAL Polygon Mesh Processing - Locate package under the terms of \
