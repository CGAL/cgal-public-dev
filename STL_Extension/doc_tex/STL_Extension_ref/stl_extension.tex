...
\begin{ccRefFunction}{cpp0x::minmax_element}
  \ccDefinition

  There is actually no function in namespace \ccc{CGAL::cpp0x} with
  this name, but a using declaration which imports a class from
...
\begin{ccRefFunction}{min_max_element}
  \begin{ccDeprecated}
    ...
    This function is deprecated. \ccc{CGAL::cpp0x::minmax_element} should be used instead.
